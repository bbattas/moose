##############################################################################
# File: 07_hex_base_long.i
# File Location: /examples/agg/01_initial_testing/11_hex_varyingAniso/07_hex_base_long
...
# -----
# Description:
#  Hex ic, base level aniso function (0.05 weight, 0 offset)
#  Longer runtime to show the weird oscillation that comes from large timesteps
#   after the structure reaches steady-state-ish
#
##############################################################################

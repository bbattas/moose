##############################################################################
# File: 04_aniso_2.i
# File Location: /examples/agg/01_initial_testing/13_newalpha_temp_large/04_aniso_2
...
# -----
# Description:
#  second larger input for DOE AGG meeting (about 3 nodes of 30?)
#
#
#
##############################################################################
...
[UserObjects]
  [voronoi]
    ...
    grain_num = 30#16 # Number of grains
    rand_seed = 35#10
    int_width = 1.55
  []
  [grain_tracker]
...
[Kernels]
  ...
  [gr0_ACIaniso]
    ...
    variable = gr0
    # v = 'gr1 gr2 gr3'
    coupled_variables = 'gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9'
  ...
  [gr1_ACIaniso]
    ...
    variable = gr1
    # v = 'gr0 gr2 gr3'
    coupled_variables = 'gr0 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9'
    gamma_name = gamma_asymm
  ...
  [gr2_ACIaniso]
    ...
    variable = gr2
    # v = 'gr0 gr1 gr3'
    coupled_variables = 'gr0 gr1 gr3 gr4 gr5 gr6 gr7 gr8 gr9'
    gamma_name = gamma_asymm
  ...
  [gr3_ACIaniso]
    ...
    variable = gr3
    # v = 'gr0 gr1 gr2'
    coupled_variables = 'gr0 gr1 gr2 gr4 gr5 gr6 gr7 gr8 gr9'
    gamma_name = gamma_asymm
  ...
  [gr4_ACIaniso]
    ...
    variable = gr4
    # v = 'gr0 gr1 gr2'
    coupled_variables = 'gr0 gr1 gr2 gr3 gr5 gr6 gr7 gr8 gr9'
    gamma_name = gamma_asymm
  ...
  [gr5_ACIaniso]
    ...
    variable = gr5
    # v = 'gr0 gr1 gr2'
    coupled_variables = 'gr0 gr1 gr2 gr3 gr4 gr6 gr7 gr8 gr9'
    gamma_name = gamma_asymm
  ...
  [gr6_ACIaniso]
    ...
    variable = gr6
    # v = 'gr0 gr1 gr2'
    coupled_variables = 'gr0 gr1 gr2 gr3 gr4 gr5 gr7 gr8 gr9'
    gamma_name = gamma_asymm
  ...
  [gr7_ACIaniso]
    ...
    variable = gr7
    # v = 'gr0 gr1 gr2'
    coupled_variables = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr8 gr9'
    gamma_name = gamma_asymm
  ...
  [gr8_ACIaniso]
    ...
    variable = gr8
    # v = 'gr0 gr1 gr2'
    coupled_variables = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr9'
    gamma_name = gamma_asymm
    dgamma_dgradop_name = dgammadgrad_eta_8
    d2gamma_dgradop2_name = d2gammadgrad_eta2_8
    mob_name = L_aniso
    dL_dgradop_name = dLdgrad_eta_8
    d2L_dgradop2_name = d2Ldgrad_eta2_8
    variable_L = true
  []
  [gr9_ACIaniso]
    type = ACInterfaceAnisoGamma
    variable = gr9
    # v = 'gr0 gr1 gr2'
    coupled_variables = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8'
    gamma_name = gamma_asymm
    dgamma_dgradop_name = dgammadgrad_eta_9
    d2gamma_dgradop2_name = d2gammadgrad_eta2_9
    mob_name = L_aniso
    dL_dgradop_name = dLdgrad_eta_9
    d2L_dgradop2_name = d2Ldgrad_eta2_9
    variable_L = true
  []
[]

##############################################################################
# File: 02_normed_alpha.i
# File Location: /examples/agg/01_initial_testing/14_bicr_alpha/02_normed_alpha
# Created Date: Monday July 7th 2025
...
# -----
# Description:
#  Using the version that did the ngb /= ngb.norm() before setting
#   uxyz = ngb (so uxyz is normalized to mag of 1 in derivs and alpha calc)
#  WRONG: alpha is meh but the derivative pieces should be using non-normed uxyz
#
##############################################################################

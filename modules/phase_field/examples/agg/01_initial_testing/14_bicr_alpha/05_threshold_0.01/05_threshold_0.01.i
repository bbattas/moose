##############################################################################
# File: 05_threshold_0.01.i
# File Location: /examples/agg/01_initial_testing/14_bicr_alpha/05_threshold_0.01
...
# -----
# Description:
#  Alpha magnitude truncation at threshold value of 0.01
#
#  Shouldnt be right? like in the derivs alpha should be 1/u.mag so setting it
#   otherwise is making the derivs wrong when u.mag isnt = threshold?
##############################################################################

##############################################################################
# File: 07_cutout_0.1.i
# File Location: /examples/agg/01_initial_testing/14_bicr_alpha/07_cutout_0.1
...
# -----
# Description:
#  cut out all points where uxyz.mag less than threshold (0.1)
#

##############################################################################
# File: 08_cutout_0.01.i
# File Location: /examples/agg/01_initial_testing/14_bicr_alpha/08_cutout_0.01
...
# -----
# Description:
#  cut out all points where uxyz.mag less than threshold (0.01)
#
#  Probably the most correct of the things im testing? just might narrow
#   interface too much and hurt convergence that way?
##############################################################################

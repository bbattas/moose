##############################################################################
# File: 13_old_thresh_0.1.i
# File Location: /examples/agg/01_initial_testing/14_bicr_alpha/13_old_thresh_0.1
# Created Date: Wednesday July 9th 2025
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday July 9th 2025
# Modified By: Brandon Battas
# -----
# Description:
#
#  old material version from doe agg but with just the threshold of 0.1 in the
#   alpha calc (alpha = 1/max(thresh,uxyz.norm))
#
##############################################################################

##############################################################################
# File: 16_subzero_0.01.i
# File Location: /examples/agg/01_initial_testing/14_bicr_alpha/16_subzero_0.01
...
# -----
# Description:
#  set alpha = 0 and then just skipped the looped derivs with alpha and set
#  the end result = 0 there too?
#
#
##############################################################################

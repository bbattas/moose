##############################################################################
# File: 07_voronoi1_hgb1.5_1o1h_debug.i
# File Location: /examples/agg/01_initial_testing/15_alpha_hgb/07_voronoi1_hgb1.5_1o1h_debug
# Created Date: Wednesday July 16th 2025
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday July 16th 2025
# Modified By: Brandon Battas
# -----
# Description:
#  Debugging output, this shit should have been working at least based on
#   the bicrystal testing it worked great?
#
#  using a multigrain input to check the hgb alpha cutoff approach
#  threshold 1.5
#  FIRST order mesh with constant L (wihtout offdiags in kernels)
##############################################################################
...
[Materials]
  ...
  [incl_test01]
    ...
    gamma_name = gamma_asymm
    mu_name = mu
    output_properties = 'gamma_asymm L_aniso mu gb_energy int_width alpha_out
    inclination_mat testout2 testout3 dgammadgrad_eta_1 d2gammadgrad_eta2_1'
    outputs = 'exodus'
  []
  [sumgr]
    type = ParsedMaterial
  ...
  [h_alpha]
    ...
    coupled_variables = 'gr0 gr1 gr2 gr3 gr4 gr5'
    material_property_names = 'hgb alpha_out'
    expression = 'hgb * alpha_out'
    outputs = 'exodus'
  []
  # Variable Gradients
  [ng_gr0]

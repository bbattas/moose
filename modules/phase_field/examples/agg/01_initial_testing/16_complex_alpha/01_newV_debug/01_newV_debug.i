##############################################################################
# File: 01_newV_debug.i
# File Location: /examples/agg/01_initial_testing/16_complex_alpha/01_newV_debug
...
# -----
# Description:
#  debugging output for specified voronoi so i can try to get both multigrain
#   issues as well as small shrinking grain issues in one problem yay
#
#
##############################################################################
...
[Materials]
  ...
  [incl_test01]
    ...
    inclination_mat testout testout2 testout3 dgammadgrad_eta_0 d2gammadgrad_eta2_0 gtnum atens'
    outputs = 'exodus'
  []
  [sumgr]
    type = ParsedMaterial

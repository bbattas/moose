##############################################################################
# File: 08_newV_newhgb.i
# File Location: /examples/agg/01_initial_testing/16_complex_alpha/08_newV_newhgb
# Created Date: Tuesday July 29th 2025
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday July 30th 2025
# Modified By: Brandon Battas
# -----
# Description:
#  newV polycrystal IC for testing the thresholds and hgb i pulled out from 07
#
#
#
##############################################################################
...
[UserObjects]
  [voronoi]
    ...
    # rand_seed = 22 #10
    int_width = 6 #1.55
    file_name = ../06_newV_moreAniso/coarser_ctrs.txt
  []
  [grain_tracker]
    type = GrainTracker
    # variable = eta
...
[Materials]
  ...
  [incl_test01]
    ...
    angular_func = atan
    alphacase = BOTH
    intol = 50#200 #200 # cut if alpha > intol (-2)
    altol = 20 #10 #1.5 # cut if h*alpha > altol (-1)
    hgb = h_test
    moelans_mu = false
    aniso_L = false
    # Output Names
    ...
    inclination_mat testout testout2 testout3 dgammadgrad_eta_0 d2gammadgrad_eta2_0 t2tens ngbtens gtnum'
    outputs = 'exodus'
  []
  # [aniso_mat]
  #   type = GGInclinationMaterial
  ...
  # [h_alpha01]
  #   type = ParsedMaterial
  #   property_name = h_alpha01
  #   coupled_variables = 'gr0 gr1 gr2 gr3 gr4 gr5'
  #   material_property_names = 'hgb t2tens_01 h_test'
  #   expression = 'h_test * t2tens_01'
  #   outputs = 'exodus'
  # []
  # Variable Gradients
  [ng_gr0]

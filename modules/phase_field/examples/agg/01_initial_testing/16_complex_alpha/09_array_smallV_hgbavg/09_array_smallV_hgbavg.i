##############################################################################
# File: 09_array_smallV_hgbavg.i
# File Location: /examples/agg/01_initial_testing/16_complex_alpha/09_array_smallV_hgbavg
# Created Date: Thursday July 31st 2025
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Thursday July 31st 2025
# Modified By: Brandon Battas
# -----
# Description:
#  Using a smaller section of vishals case3 voronoi to test varying values for
#   the two thresholds in a complex problem as a slurm array on HPG
#  Using the avg then capped hgb
#
##############################################################################
...
[UserObjects]
  [voronoi]
    ...
    file_name = 'vishal_small_128.txt'
    int_width = 6
  []
  [term]
    type = Terminator
...
[Outputs]
  ...
  []
  file_base = 09_hgbavg_i${i_tol}_a${a_tol}
[]

##############################################################################
# File: 06_asmlu_fullSMP.i
# File Location: /examples/agg/01_initial_testing/17_noGrainTracker/06_asmlu_fullSMP
...
# -----
# Description:
#  Full SMP preconditioning with the asm lu petsc from 05
#
#
#
##############################################################################
...
[Outputs]
  ...
  []
  file_base = 06_asmlu_fullSMP_i${i_tol}_a${a_tol}
[]

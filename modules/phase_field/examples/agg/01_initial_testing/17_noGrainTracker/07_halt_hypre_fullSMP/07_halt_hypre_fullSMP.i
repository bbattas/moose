##############################################################################
# File: 07_halt_hypre_fullSMP.i
# File Location: /examples/agg/01_initial_testing/17_noGrainTracker/07_halt_hypre_fullSMP
...
# -----
# Description:
#  hgb alt version that seems better, testing hypre WITH smp
#
#
#
##############################################################################
...
[Outputs]
  ...
  []
  file_base = 07_halt_hypre_fullSMP_i${i_tol}_a${a_tol}
[]

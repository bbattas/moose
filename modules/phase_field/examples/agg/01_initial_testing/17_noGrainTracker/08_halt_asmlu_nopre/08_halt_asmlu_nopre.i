##############################################################################
# File: 08_halt_asmlu_nopre.i
# File Location: /examples/agg/01_initial_testing/17_noGrainTracker/08_halt_asmlu_nopre
...
# -----
# Description:
#  hgb alt version that seems better, testing asm lu without smp
#
#
#
##############################################################################
...
[Outputs]
  ...
  []
  file_base = 08_halt_asmlu_nopre_i${i_tol}_a${a_tol}
[]

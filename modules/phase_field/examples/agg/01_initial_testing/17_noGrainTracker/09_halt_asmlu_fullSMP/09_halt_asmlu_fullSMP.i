##############################################################################
# File: 09_halt_asmlu_fullSMP.i
# File Location: /examples/agg/01_initial_testing/17_noGrainTracker/09_halt_asmlu_fullSMP
...
# -----
# Description:
#  alternate better hgb with asm lu and the full smp preconditioning
#
#
#
##############################################################################
...
[Outputs]
  ...
  []
  file_base = 09_halt_asmlu_fullSMP_i${i_tol}_a${a_tol}
[]

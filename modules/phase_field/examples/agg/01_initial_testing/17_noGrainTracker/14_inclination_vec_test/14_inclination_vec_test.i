##############################################################################
# File: 14_inclination_vec_test.i
# File Location: /examples/agg/01_initial_testing/17_noGrainTracker/14_inclination_vec_test
# Created Date: Thursday August 14th 2025
...
# -----
# Description:
#  Looking at the inclination vector material outputs since the hgb thickness
#   is still inclination weighted a bit so that will skew the inclin vec material
#   output i want to use for the distribution
#
##############################################################################

##############################################################################
# File: 18_bicr_newatan.i
# File Location: /examples/agg/01_initial_testing/17_noGrainTracker/18_bicr_newatan
...
# -----
# Description:
#  Testing the development of an atan2 usage in the ggincmat that returns full
#   360 degree adist instead of just 0-180 for positive and negative 0-180
#
#
##############################################################################
...
[Materials]
  ...
  [aniso_mat]
    ...
    mu_name = mu
    gb_energy = sigma
    output_properties = 'gamma_asymm L mu sigma int_width inclination_mat inclination_distance t2tens dadb' # inclination_mat t2tens'
    outputs = 'exodus'
  []
  [hgb_a]
    type = ParsedMaterial

##############################################################################
# File: 02_a0.025_b2.i
# File Location: /examples/agg/01_initial_testing/22_bicr_fullkernel_anisoMag/02_a0.025_b2
# Created Date: Wednesday October 1st 2025
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday October 1st 2025
# Modified By: Brandon Battas
# -----
# Description:
#  Aniso input with a magnitude of 0.025 and theta prefactor = 2
#  Bicrystal for comparing to Lin's paper (using the m corrected kernel)
#
#
##############################################################################

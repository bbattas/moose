##############################################################################
# File: 12_cos_5op_GT.i
# File Location: /examples/agg/01_initial_testing/24_newMat/12_cos_5op_GT
# Created Date: Monday December 1st 2025
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Monday December 1st 2025
# Modified By: Brandon Battas
# -----
# Description:
#  same as 11 which seems to be working, but with grain tracker instead of ffc
#
#
#
##############################################################################
...
[UserObjects]
  [voronoi]
    ...
    file_name = '../11_cos_5op_voronoi/ctrs_5gr_d3d.txt'
    int_width = 12
  []
  [grain_tracker]
    type = GrainTracker
...
[Materials]
  ...
  [GBInc_cos]
    ...
    grain_tracker = grain_tracker
    angular_func = ATAN_2D
    intol = 1000 #100 #10 #100 #200 # cut if alpha > intol

##############################################################################
# File: 18_higherGT_5op_IC2.i
# File Location: /examples/agg/01_initial_testing/24_newMat/18_higherGT_5op_IC2
# Created Date: Thursday December 11th 2025
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Thursday December 11th 2025
# Modified By: Brandon Battas
# -----
# Description:
#  trying varying the GT thresholds to see if that changes the coalescence issue?
#
#
#
##############################################################################
...
[UserObjects]
  [voronoi]
    ...
    file_name = '../15_cos_5op_IC2/d3d_ctrs.txt'
    int_width = 8
  []
  [grain_tracker]
    type = GrainTracker
...
[Materials]
  ...
  [GBInc_cos]
    ...
    grain_tracker = grain_tracker
    angular_func = ATAN_2D
    intol = 0 #1000 #100 #10 #100 #200 # cut if alpha > intol
    altol = 0 #10 #100 #10 #1.5 # cut if h*alpha > altol
  ...
  #   coupled_variables = 'gr0 gr1 gr2 gr3 gr4 inc_01 inc_02 inc_03 inc_04 inc_12 inc_13 inc_14 inc_23 inc_24 inc_34'
  #   expression = 'num:= inc_01 * gr0 * gr0 * gr1 * gr1 + inc_02 * gr0 * gr0 * gr2 * gr2 + inc_03 * gr0 * gr0 * gr3 * gr3 + inc_04 * gr0 * gr0 * gr4 * gr4
  #    + inc_12 * gr1 * gr1 * gr2 * gr2 + inc_13 * gr1 * gr1 * gr3 * gr3 + inc_14 * gr1 * gr1 * gr4 * gr4
  #    + inc_23 * gr2 * gr2 * gr3 * gr3 + inc_24 * gr2 * gr2 * gr4 * gr4 + inc_34 * gr3 * gr3 * gr4 * gr4;
  #   den:= gr0 * gr0 * gr1 * gr1 + gr0 * gr0 * gr2 * gr2 + gr0 * gr0 * gr3 * gr3 + gr0 * gr0 * gr4 * gr4
  #   + gr1 * gr1 * gr2 * gr2 + gr1 * gr1 * gr3 * gr3 + gr1 * gr1 * gr4 * gr4
  #   + gr2 * gr2 * gr3 * gr3 + gr2 * gr2 * gr4 * gr4 + gr3 * gr3 * gr4 * gr4;
  #   num/den'
  #   outputs = 'exodus'
  # []
  # [sum_theta]
  ...
  #   coupled_variables = 'gr0 gr1 gr2 theta_01_v theta_02_v theta_12_v'
  #   expression = 'num:= theta_01_v * gr0 * gr0 * gr1 * gr1 + theta_02_v * gr0 * gr0 * gr2 * gr2 + theta_12_v * gr1 * gr1 * gr2 * gr2;

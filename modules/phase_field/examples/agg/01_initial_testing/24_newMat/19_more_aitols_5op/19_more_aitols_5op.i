##############################################################################
# File: 19_more_aitols_5op.i
# File Location: /examples/agg/01_initial_testing/24_newMat/19_more_aitols_5op
...
# -----
# Description:
#  adding more tests to the 16 ai tols, for higher amag (0.2/0.3)
#
#
#
##############################################################################
...
[Outputs]
  ...
  # []
  file_base = amag_${amag}_ur${ur}/16_cos_5op_a${a_tol}_i${i_tol}

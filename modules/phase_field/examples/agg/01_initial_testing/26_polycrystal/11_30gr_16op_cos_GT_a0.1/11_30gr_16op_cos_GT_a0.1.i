##############################################################################
# File: 11_30gr_16op_cos_GT_a0.1.i
# File Location: /examples/agg/01_initial_testing/26_polycrystal/11_30gr_16op_cos_GT_a0.1
...
[Materials]
  ...
  [hgb_a]
    ...
    expression = 'hb:=gr0*gr0 + gr1*gr1 + gr2*gr2 + gr3*gr3 + gr4*gr4 + gr5*gr5 + gr6*gr6 + gr7*gr7 + gr8*gr8 + gr9*gr9 + gr10*gr10 + gr11*gr11 + gr12*gr12 + gr13*gr13 + gr14*gr14 + gr15*gr15;
                  4 * (1 - hb) * (1 - hb)'
    outputs = 'exodus'
  []
  [hgb_b]

##############################################################################
# File: 02_huge_mesh.i
# File Location: /examples/agg/01_initial_testing/28_VECTOR_inclination/02_huge_mesh
...
# -----
# Description:
#  testing the same exodus/nemesis stuff with my vector inclination script
#   but with a much larger mesh to test scaling performance of the parallel
#   calculation in my TIGER/VECTOR code
#  About 1.2m dofs, so 1 node of 30-60 can handle it im sure
##############################################################################
...
[Mesh]
  ...
  [gmg]
    ...
    nx = 800 # Number of elements in the x-direction
    ny = 800 # Number of elements in the y-direction

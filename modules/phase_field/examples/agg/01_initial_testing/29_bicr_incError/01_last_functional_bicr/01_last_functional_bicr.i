##############################################################################
# File: 01_last_functional_bicr.i
# File Location: /examples/agg/01_initial_testing/29_bicr_incError/01_last_functional_bicr
...
# -----
# Description:
#  This was the most recent input i have that actually showed inclination?
#  24_newMat/14_cos_nice_2op
#  Going to use this as the base and build from here to what im running now to
#   see whats causing it to not have inclination.  i bet its graintracker thresholds
##############################################################################

##############################################################################
# File: 05_5gr_aicheck.i
# File Location: /examples/agg/01_initial_testing/29_bicr_incError/05_5gr_aicheck
...
# -----
# Description:
#  5 grain version for more angles on the center grain as it dissapears
#
#
#
##############################################################################
...
[Outputs]
  ...
  []
  file_base = 05_5gr_aicheck_i${i_tol}_a${a_tol}

##############################################################################
# File: 01_1cpu_base.i
# File Location: /examples/agg/01_initial_testing/37_suo_parallelization_ic/01_1cpu_base
...
# -----
# Description:
#  was grain_growth_2D_voronoi test input
#  Want to see how solution user object handles 1cpu to 4 cpu vs 4->4 for
#   solution user object ona  small test
# INFO: Finished. Runtime: 0h 0m 53.30s | Peak memory delta: 323536.0 MB
##############################################################################

##############################################################################
# File: 02_1cpu_main.i
# File Location: /examples/agg/01_initial_testing/37_suo_parallelization_ic/02_1cpu_main
...
# -----
# Description:
#  Main file reading the exodus with 1 cpu to run this with 4
#
#
#  INFO: Finished. Runtime: 0h 0m 13.11s | Peak memory delta: 201152.0 MB
##############################################################################
...
[UserObjects]
  ...
  [solution_userobject]
    ...
    mesh = '../01_1cpu_base/01_1cpu_base_out.e'
    timestep = 'LATEST'

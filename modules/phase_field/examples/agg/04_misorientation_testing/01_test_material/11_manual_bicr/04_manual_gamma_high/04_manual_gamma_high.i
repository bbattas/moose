##############################################################################
# File: 04_manual_gamma_high.i
# File Location: /examples/agg/04_misorientation_testing/01_test_material/11_manual_bicr/04_manual_gamma_high
# Created Date: Thursday February 19th 2026
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Thursday February 19th 2026
# Modified By: Brandon Battas
# -----
# Description:
#  manual input without misorientation material using the gamma (min) and iw (max)
#   determined in the high misorientation input
#
#
##############################################################################
...
[Mesh]
  [ebsd_mesh]
    ...
    filename = '../../00_sub/manual_bicr_high_r45.txt'
  []
  # [gmg]
...
[Materials]
  ...
  [constants2]
    type = GenericConstantMaterial
    prop_names = 'int_width gamma_asymm'
    prop_values = '6.0867 1.186'
  []
  [hgb]

##############################################################################
# File: 10_manualL_high.i
# File Location: /examples/agg/04_misorientation_testing/01_test_material/11_manual_bicr/10_manualL_high
...
# -----
# Description:
#  manually setting everything, including L as per the Mgb*gbe = kappa*L
#
#
#
##############################################################################
...
[Materials]
  ...
  [constants2]
    ...
    prop_values = '6.0867     1.1862    4.5612e6  1.142220e-06'
  []
  [hgb]

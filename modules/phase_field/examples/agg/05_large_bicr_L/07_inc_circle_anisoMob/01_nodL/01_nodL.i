##############################################################################
# File: 01_nodL.i
# File Location: /examples/agg/05_large_bicr_L/07_inc_circle_anisoMob/01_nodL
...
# -----
# Description:
#  for cirlce version- yic stays 80 the whole time
#
#
#
##############################################################################
...
[Outputs]
  ...
  # []
  file_base = 01_a${amag}_circle_nodL/01_a${amag}_circle_nodL_out
[]

##############################################################################
# File: 02_main_poly_inc_anisoL.i
# File Location: /examples/agg/05_large_bicr_L/09_inc_poly11gr/02_poly_inc_anisoL
...
# -----
# Description:
#  main file for aniso L with second order variable ICs coming from the sub.i
#
#
#
##############################################################################
...
[MultiApps]
  [full_sub]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../../00_sub/01_sub_poly10gr.i
  []
[]
...
[Transfers]
  [from_sub]
    ...
    source_variable = 'gr0a gr1a gr2a gr3a gr4a gr5a gr6a gr7a gr8a gr9a'
...
[Materials]
  ...
  [inc_mat]
    ...
    output_properties = 'int_width gamma_asymm L sigma'
    outputs = 'exodus'
  []
  #
  # [GBM]
...
[Outputs]
  ...
  # []
  file_base = 02_a${amag}_poly_anisoL/02_a${amag}_poly_anisoL_out
[]

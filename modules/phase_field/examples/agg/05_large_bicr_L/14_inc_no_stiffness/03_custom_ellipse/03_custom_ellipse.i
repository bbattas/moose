##############################################################################
# File: 03_custom_ellipse.i
# File Location: /examples/agg/05_large_bicr_L/14_inc_no_stiffness/03_custom_ellipse
...
# -----
# Description:
#  Using the newly determined ellipse IC aspect ratios for this no stiffness case
#
#
#
##############################################################################
...
[Outputs]
  ...
  # []
  file_base = 03_a${amag}_aspect_ellipse_nostiffness/03_a${amag}_aspect_ellipse_nostiffness_out
[]

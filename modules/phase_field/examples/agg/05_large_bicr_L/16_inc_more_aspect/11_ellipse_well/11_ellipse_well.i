##############################################################################
# File: 11_ellipse_well.i
# File Location: /examples/agg/05_large_bicr_L/16_inc_more_aspect/11_ellipse_well
# Created Date: Tuesday March 17th 2026
...
# -----
# Description:
#  1.5 ellipse with well function and elemental consistent values
#
#
#
##############################################################################
...
[Materials]
  ...
  [inc_mat]
    ...
    output_properties = 'int_width_qp gamma_qp L_qp'
    outputs = 'exodus'
  []
  [elem_gamma]
    type = ElementalGammaWellMaterial
...
[Outputs]
  ...
  # []
  file_base = 11_a${amag}_ellipse_well/11_a${amag}_ellipse_well_out
[]

##############################################################################
# File: 07_inc_nostiffness.i
# File Location: /examples/agg/07_DOE_examples/07_inc_nostiffness
# Created Date: Friday April 3rd 2026
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Friday April 3rd 2026
# Modified By: Brandon Battas
# -----
# Description:
#  1+acos for no stiffness
#
#
#
##############################################################################
...
[Outputs]
  ...
  # []
  file_base = 07_inc_a${amag}_nostiffness/07_inc_a${amag}_nostiffness_out
  # [csv]
  #   type = CSV
  #   execute_on = 'INITIAL TIMESTEP_END'
  #   # execute_on = 'CUSTOM'

##############################################################################
# File: 14_miso_1.i
# File Location: /examples/agg/07_DOE_examples/14_miso_1
...
# -----
# Description:
#  another input for the full 1x scale miso input with the corrected
#   euler angles for misorientation (needed to convert to degrees internally)
#
#
##############################################################################

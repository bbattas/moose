##############################################################################
# File: 17_miso_large_mack.i
# File Location: /examples/agg/07_DOE_examples/17_miso_large_mack
# Created Date: Wednesday April 22nd 2026
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday April 22nd 2026
# Modified By: Brandon Battas
# -----
# Description:
#  4x larger input to try to run a 1000 grain case
#  mackenzie distribution of grain misorientations
#
#
##############################################################################
...
[UserObjects]
  [euler_file]
    ...
    file_name = '../00_sub/euler_large.txt'
    # file_name = '../00_sub/euler_textured2.txt'
  []
  [voronoi]
...
[Materials]
  ...
  [GBM]
    ...
    kappa = kappa_op
    bulk_scale = 1
    output_properties = 'misorientation f_miso gamma_asymm int_width'
    outputs = exodus
  []
  [hgb]

##############################################################################
# File: 02_old_cos_ref.i
# File Location: /examples/agg/08_combined/02_combined_devel/02_old_cos_ref
...
# -----
# Description:
#  same as input 1 using the old inc cos so i can make sure it works
#
#
#
##############################################################################
...
[Materials]
  ...
  #   output_properties = 'gt_num testout_1 theta_out noij_out L_a gamma_asymm_a int_width_a'
  #   outputs = 'exodus'
  # []
  [GBInc_cos]
    type = GBInclination

##############################################################################
# File: 04_old_miso_ref.i
# File Location: /examples/agg/08_combined/02_combined_devel/04_old_miso_ref
# Created Date: Thursday May 14th 2026
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Thursday May 14th 2026
# Modified By: Brandon Battas
# -----
# Description:
#  Reference using the older miso material to compare to the temporarily
#  0.3 + 0.7*miso in the main
#
#
##############################################################################
...
[Materials]
  ...
  [constants]
    type = GenericConstantMaterial
    prop_names = 'L0             kappa_op   mu      sigma   '
  ...
  #   output_properties = 'gt_num testout_1 theta_out noij_out L_a gamma_asymm_a int_width_a fgbe'
  #   outputs = 'exodus'
  # []
  [GBM]
    ...
    kappa = kappa_op
    bulk_scale = 1
    output_properties = 'misorientation twist_energy tilt_energy f_miso gamma_asymm int_width L'
    outputs = exodus
  []
[]

##############################################################################
# File: 02_inc_bulk75.i
# File Location: /examples/agg/08_combined/03_new_inc_tols/02_inc_bulk75
...
# -----
# Description:
#  new inclination only function testing tolerances using bulk scale of 0.75
#
#
#
##############################################################################
...
[Outputs]
  ...
  # []
  file_base = 02_inc_bulk75_a${a_tol}_h${h_tol}_out
[]

##############################################################################
# File: 03_inc_bulk5.i
# File Location: /examples/agg/08_combined/03_new_inc_tols/03_inc_bulk5
...
# -----
# Description:
#  new inclination only function testing tolerances using bulk scale of 0.5
#
#
#
##############################################################################
...
[Outputs]
  ...
  # []
  file_base = 03_inc_bulk5_a${a_tol}_h${h_tol}_out
[]

##############################################################################
# File: 07_inc_nomask_bulk1.i
# File Location: /examples/agg/08_combined/03_new_inc_tols/07_inc_nomask_bulk1
...
# -----
# Description:
#  Testing tolerances with the hgb mask disabled
#
#
#
##############################################################################
...
[Outputs]
  ...
  # []
  file_base = 07_inc_nomask_bulk1_a${a_tol}_h${h_tol}_out
[]

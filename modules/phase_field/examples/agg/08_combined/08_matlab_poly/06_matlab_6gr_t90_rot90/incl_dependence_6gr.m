...
order_par = 6;
bound_cond = 'pp';
delta_s = [0 0.15 0.15 0.15 0.15 0.15;0 0 0.15 0.15 0.15 0.15; 0 0 0 0.15 0.15 0.15; ...
...
ofset_angle = [0 pi/2 pi/2 pi/2 pi/2 pi/2; 0 0 pi/2 pi/2 pi/2 pi/2; 0 0 0 pi/2 pi/2 pi/2; 0 0 0 0 pi/2 pi/2; 0 0 0 0 0 pi/2; 0 0 0 0 0 0];

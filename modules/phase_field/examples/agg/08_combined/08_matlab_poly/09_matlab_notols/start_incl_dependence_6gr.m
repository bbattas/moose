...
ic_file = '07_pf_6gr_notols_exodus_ic_t90.mat';   % <-- set to your generated filename
data = load(ic_file);
...
% RUN
[eta,sumetasqu,grain_area] = anisotropic_grgr_incl_in_gamma(invoer,n,n_old,eta,2500,grain_area);

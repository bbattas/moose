...
g = [0 sqrt(2)/3 sqrt(2)/3 sqrt(2)/3;  0 0 sqrt(2)/3 sqrt(2)/3; 0 0 0 sqrt(2)/3 ; 0 0 0 0];
...
order_par = 4;
bound_cond = 'pp';
delta_s = [0 0.15 0.15 0.15; 0 0 0.15 0.15; 0 0 0 0.15; 0 0 0 0;];
...
delta_s_kin = zeros(4,4);
%delta_s = [0 0;0 0];
n_fold = [0 2 2 2; 0 0 2 2; 0 0 0 2; 0 0 0 0];
n_fold_kin = [0 2 2 2; 0 0 2 2; 0 0 0 2; 0 0 0 0];
ofset_angle = [0 pi/4 pi/4 pi/4; 0 0 pi/4 pi/4; 0 0 0 pi/4; 0 0 0 0;];
...
ofset_angle_kin = zeros(4,4);
anis = [0 'w' 'w' 'w' ; 0 0 'w' 'w'; 0 0 0 'w'; 0 0 0 0;];

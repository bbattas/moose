##############################################################################
# File: 16_pf_hex_nomask.i
# File Location: /examples/agg/08_combined/08_matlab_poly/16_pf_hex_nomask
# Created Date: Wednesday June 3rd 2026
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday June 3rd 2026
# Modified By: Brandon Battas
# -----
# Description:
#  removing the hgb mask
#
#
#
##############################################################################
...
[ICs]
  [PolycrystalICs]
    [PolycrystalColoringIC]
      polycrystal_ic_uo = hex_ic #voronoi
    []
  []
[]
...
[AuxKernels]
  ...
  [sumetasqu]
    ...
    expression = '(gr0 * gr0) + (gr1 * gr1) + (gr2 * gr2) + (gr3 * gr3)'
    execute_on = 'initial timestep_end'
  []
[]
...
[Materials]
  ...
  [new_aniso_mat]
    ...
    hgbalpha_tol = 0
    ifunc_a = 0.15
    ifunc_rot = ${rot_ang} #0 #0.7854 #1.5708
    kappa_name = kappa_op
...
[Outputs]
  ...
  [csv]
    ...
    # execute_on = 'CUSTOM'
    sync_only = true
    sync_times = '0.0 7.5 15 22.5 30 37.5 45 52.5 60'
    # 67.5 75 82.5 90 97.5 105 112.5 120
    # 127.5 135 142.5 150 157.5 165 172.5 180'
  []
  [exodus]
    type = Exodus
    execute_on = 'INITIAL TIMESTEP_END'
    ...
    # 127.5 135 142.5 150 157.5 165 172.5 180'
  []
  file_base = 16_pf_hex_nomask_${rot_ang}rot
[]

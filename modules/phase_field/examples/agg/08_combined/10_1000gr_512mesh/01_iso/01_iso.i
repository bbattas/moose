##############################################################################
# File: 01_iso.i
# File Location: /examples/agg/08_combined/10_1000gr_512mesh/01_iso
...
# -----
# Description:
#  Full 2x mesh in x and y, with 256gr in 256x256 density,
#   so ~1k-1.1k grains in 512x512 domain
#
#  Might have some initial grains get remapped or removed for too small if
#   theyre slivers basically
#  Ballparking 15m ish dofs -> 1200=12.5k, 900=16.7k, 750=20k, 600=25k
##############################################################################

##############################################################################
# File: 13_3D_small_asmilu_full_scaled.i
# File Location: /examples/sintering/paper1/01_new_petsc_test/13_3D_small_asmilu_full_scaled
...
#  Using full preconditioning block and automatic scaling
#
#
##############################################################################
...
[ICs]
  [phi_IC]
    ...
    variable = phi
    x_positions = '510 1000 510 1000'
    y_positions = '1000 510 1000 510'
    z_positions = '  0   0   692 692'

##############################################################################
# File: 05_2D_OU2.001_T1900.i
# File Location: /examples/sintering/paper1/03_2D_simple_large_constT_newParams/05_2D_OU2.001_T1900
...
[GlobalParams]
  op_num = 2
  var_name_base = gr
  int_width = 315 #min particle radius is 4000
  profile = TANH
[]
...
[ICs]
  [phi_IC]
    ...
    variable = phi
    x_positions = '4900 9000'
    y_positions = '9000 4900'
    z_positions = '  0   0'
    radii = '2945 2945'
    invalue = 0
    outvalue = 1

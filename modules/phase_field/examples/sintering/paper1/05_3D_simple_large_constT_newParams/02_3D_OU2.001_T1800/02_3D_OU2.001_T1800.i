...
# File Location: /examples/sintering/paper1/05_3D_simple_large_constT_newParams/02_3D_OU2.001_T1800
...
#   GB Mobility
#   Lower surface D
#  Has 560k DoFs roughly, so 30~18.6k 45~12.4k
##############################################################################
...
[GlobalParams]
  op_num = 4
  var_name_base = gr
  int_width = 315 #min particle radius is 5000
  profile = TANH
[]

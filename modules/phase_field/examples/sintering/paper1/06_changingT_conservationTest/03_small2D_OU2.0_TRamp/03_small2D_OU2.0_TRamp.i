##############################################################################
# File: 03_small2D_OU2.0_TRamp.i
# File Location: /examples/sintering/paper1/06_changingT_conservationTest/03_small2D_OU2.0_TRamp
# Created Date: Wednesday May 29th 2024
...
# -----
# Description:
#  Testing if we conserve mass/vacancies or not when temperature changes in
#   a simulation with the changing cv_eq
#  This ramps the temperature constantly from 1800-2000K over the whole 1000s
#  Using new GB mobility

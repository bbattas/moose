##############################################################################
# File: 01_2DS_current.i
# File Location: /examples/sintering/paper1/09_additional_tests/01_2DS_current
# Created Date: Thursday May 15th 2025
...
# -----
# Description:
#  2D Small 1800K OU=2.0 input with the current form (for checking minor changes
#   as in the L and mass conservation solve mainly)
#  This is the L change piece
#
##############################################################################
...
[Materials]
  ...
  [chiu]
    ...
    constant_names = 'Va'
    constant_expressions = '0.04092'
    material_property_names = 'chi(wvac,phi,gr0,gr1)'
    expression = 'Va * chi'
  []
[]

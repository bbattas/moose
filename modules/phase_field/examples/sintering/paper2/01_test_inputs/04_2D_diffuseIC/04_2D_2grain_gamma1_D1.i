##############################################################################
# File: 04_2D_2grain_gamma1_D1.i
# File Location: /examples/sintering/paper2/01_test_inputs/04_2D_diffuseIC/04_2D_2grain_gamma1_D1.i
# Created Date: Tuesday September 12th 2023
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday September 12th 2023
# Modified By: Brandon Battas
# -----
# Description:
#  The basic 2grain gamma=1 Dgb/Ds=1 input (05>01) but in 2D
#  Using this to test the value to use for the diffuse interface
#  in the IC so that it doesnt have to change from the first timestep on
#  Dont need it? its in global params already and changing it makes it weird
##############################################################################

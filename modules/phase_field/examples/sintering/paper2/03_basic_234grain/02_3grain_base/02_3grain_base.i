##############################################################################
# File: 02_3grain_base.i
# File Location: /examples/sintering/paper2/03_basic_234grain/02_3grain_base/02_3grain_base.i
...
# -----
# Description:
#  Base input for full 3 grain structure (all centered in y axis or xz plane)
#  delta=iw, so Dgb = Ds/iw = 1e11/20 = 5e9
#  sigma_gb=sigma_s=sig5tiltgb=9.86 eV/nm2
#  200x120x190 had 23m DoFs-> 300(77k/ea), 450(~51k/ea), 600(~38k/ea)
##############################################################################

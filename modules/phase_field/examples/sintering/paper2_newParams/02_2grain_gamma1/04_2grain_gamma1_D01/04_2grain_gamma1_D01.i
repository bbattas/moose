##############################################################################
# File: 04_2grain_gamma1_D01.i
# File Location: /examples/sintering/paper2_newParams/02_2grain_gamma1/04_2grain_gamma1_D01
...
# -----
# Description:
#  NEW Params with del*Dgb/Ds = 0.1, sigma_gb/sigma_s = 1
#  Dgb = 5.8422e7, Ds = 10*iw*Dgb = 1.16844e10
#
# OLD: Full 2 grain structure, del*Dgb/Ds = 0.1, sigma_gb/sigma_s = 1
#  delta=iw but on scaled D internal value, so backcalc Dgb = 1e6, Ds = 2e8
#  sigma_gb=sigma_s=sig5tiltgb=9.86 eV/nm2
#  01 2grain input but with different D
#  100x60x60 had 1.5m DoFs-> 150(10k/ea), 90(~17k/ea)
##############################################################################
...
[Materials]
  ...
  [chiD]
    ...
    surfindex = 1.16844e10 #10*iw*DGB  #5.8422e10

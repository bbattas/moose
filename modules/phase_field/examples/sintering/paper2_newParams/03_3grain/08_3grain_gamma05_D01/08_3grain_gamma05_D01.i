##############################################################################
# File: 08_3grain_gamma05_D01.i
# File Location: /examples/sintering/paper2_newParams/03_3grain/08_3grain_gamma05_D01
...
# -----
# Description:
#  NEW: finer mesh 3 grain input with
#   Dgb = 5.8422e7, Ds = 10*iw*Dgb = 1.16844e10, sigma_s = 2*sigma_gb
#
#  OLD: Full 3 grain structure, del*Dgb/Ds = 0.1, sigma_gb/sigma_s = 0.5

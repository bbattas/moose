##############################################################################
# File: 21_4grain_gamma1_D03.i
# File Location: /examples/sintering/paper2_newParams/04_4grain_gamma1/21_4grain_gamma1_D03
...
#   Dgb = 5.8422e7, Ds = iw*Dgb/0.3 = 3.89480e9
#
#  OLD: Additional inputs with intermediary delDgb/Ds
#  Full 3 grain structure, del*Dgb/Ds = 0.3, sigma_gb/sigma_s = 1
#  delta=iw but on scaled D internal value, so backcalc Dgb = 1e6, Ds = 6.67e7
...
[Materials]
  ...
  [chiD]
    ...
    surfindex = 3.89480e9 #iw*DGB/0.3  #5.8422e10

##############################################################################
# File: 22_4grain_gamma1_D003.i
# File Location: /examples/sintering/paper2_newParams/04_4grain_gamma1/22_4grain_gamma1_D003
...
# -----
# Description:
#  New parameters and MC version of 4 grain input
#   Dgb = 5.8422e7, Ds = iw*Dgb/0.03 = 3.89480e10
#
#  OLD: Additional inputs with intermediary delDgb/Ds
#  Full 3 grain structure, del*Dgb/Ds = 0.03, sigma_gb/sigma_s = 1
#  delta=iw but on scaled D internal value, so backcalc Dgb = 1e6, Ds = 6.67e8
#  sigma_gb=sigma_s=sig5tiltgb=9.86 eV/nm2
#  input 03 with different D
...
[MultiApps]
  [NMC_1step]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../../00_sub/03_sub_4grain.i
  []
[]
...
[Transfers]
  [from_NMC]
    ...
    source_variable = 'gr0 gr1 gr2 gr3 phi cvac_aux_th'
    variable = 'gr0 gr1 gr2 gr3 phi cvac_var'
  []
[]
...
[Materials]
  ...
  [chiD]
    ...
    surfindex = 3.89480e10 #iw*DGB/0.03  #5.8422e10

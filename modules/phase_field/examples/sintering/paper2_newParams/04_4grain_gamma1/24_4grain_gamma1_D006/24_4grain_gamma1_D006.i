##############################################################################
# File: 24_4grain_gamma1_D006.i
# File Location: /examples/sintering/paper2_newParams/04_4grain_gamma1/24_4grain_gamma1_D006
...
#   Dgb = 5.8422e7, Ds = iw*Dgb/0.06 = 1.94740e10
#
#  OLD: Additional inputs with intermediary delDgb/Ds
#  Full 3 grain structure, del*Dgb/Ds = 0.06, sigma_gb/sigma_s = 1
#  delta=iw but on scaled D internal value, so backcalc Dgb = 1e6, Ds = 3.33e8
...
[Materials]
  ...
  [chiD]
    ...
    surfindex = 1.94740e10 #iw*DGB/0.06  #5.8422e10

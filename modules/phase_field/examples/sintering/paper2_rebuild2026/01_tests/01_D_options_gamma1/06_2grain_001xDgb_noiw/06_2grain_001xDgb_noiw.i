##############################################################################
# File: 06_2grain_001xDgb_noiw.i
# File Location: /examples/sintering/paper2_rebuild2026/01_tests/01_D_options_gamma1/06_2grain_001xDgb_noiw
# Created Date: Tuesday June 23rd 2026
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday June 23rd 2026
# Modified By: Brandon Battas
# -----
# Description:
#  0.01 x Dgb for the same Ds/Dgb ratio but changing gb instead of s
#  no iw scaling
#
#
##############################################################################
...
[MultiApps]
  [NMC_1step]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../../../00_sub/01_sub_2grain.i
  []
[]
...
[Transfers]
  [from_NMC]
    ...
    source_variable = 'gr0 gr1 phi cvac_aux_th'
...
[Materials]
  ...
  [chiD]
    ...
    Em = 4.23317 #3.608
    bulkindex = 1
    gbindex = 5.8422e5 # GB avg from 9/11 at 1600 # -1 sets the GB D to the LANL MD Value in GPIsoMat
    surfindex = 5.8422e7 #1.16844e9 #iw*DGB  #5.8422e10
    GBwidth = 3.5 # based on avg of two lanl values
    surf_thickness = 3.5 # keeping equal to gb for simplicity
    iw_scaling = false
    output_properties = 'diffusivity int_width'
    outputs = 'nemesis'
  []
  [cv_eq]
    type = UO2CeqMaterial

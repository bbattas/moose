...
# File Location: /examples/sintering/paper2_rebuild2026/02_234_gamma1_D1/03_4grain_gamma1_D1
...
# -----
# Description:
#  Same as before but with actually equal Ds and Dgb @ gb value
#
#  OLD: new parameters and MC version of 4 grain base/ref input
#  Dgb = 5.8422e7, Ds = iw*Dgb = 1.16844e9
#
#  OLD: Full 3 grain structure, del*Dgb/Ds = 1, sigma_gb/sigma_s = 1

##############################################################################
# File: 01_2grain_gamma1_D1.i
# File Location: /examples/sintering/paper2_rebuild2026/02_234_gamma1_D1/01_2grain_gamma1_D1
...
# -----
# Description:
#  New input set with ACTUALLY equal Ds and Dgb (delta=iw applied to both not just surface)
#
#  OLD: New version of the old paper 2 inputs (new D, gbmob, gb/seEnergy, and ceq (and time))
...
[Materials]
  ...
  [chiD]
    ...
    surfindex = 5.8422e7 # =GB #1.16844e9 #iw*DGB  #5.8422e10

##############################################################################
# File: 05_2grain_gamma1_D001.i
# File Location: /examples/sintering/paper2_rebuild2026/03_2grain_gamma1/05_2grain_gamma1_D001
...
# -----
# Description:
#  NEW Params with Dgb/Ds = 0.01, sigma_gb/sigma_s = 1
#  Dgb = 5.8422e7, Ds = 100*Dgb = 5.8422e9
#
# OLD: Full 2 grain structure, del*Dgb/Ds = 0.01, sigma_gb/sigma_s = 1
...
[Materials]
  ...
  [chiD]
    ...
    surfindex = 5.8422e9 # 100*DGB  #5.8422e10

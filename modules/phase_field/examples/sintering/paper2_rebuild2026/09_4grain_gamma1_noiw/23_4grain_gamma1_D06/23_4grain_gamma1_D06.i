##############################################################################
# File: 23_4grain_gamma1_D06.i
# File Location: /examples/sintering/paper2_rebuild2026/05_4grain_gamma1/23_4grain_gamma1_D06
...
#   Dgb = 5.8422e7, Ds = Dgb/0.6 = 9737e7
#
#  OLD: Additional inputs with intermediary delDgb/Ds
#  Full 3 grain structure, del*Dgb/Ds = 0.6, sigma_gb/sigma_s = 1
...
[Materials]
  ...
  [chiD]
    ...
    surfindex = 9.737e7 #iw*DGB/0.6  #5.8422e10

##############################################################################
# File: 03_2D_dream3dIC.i
# File Location: /examples/sintering/paper3/01_test_inputs/03_2D_dream3dIC
# Created Date: Monday October 23rd 2023
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Monday October 23rd 2023
# Modified By: Brandon Battas
# -----
# Description:
#  Using the EBSDReader in moose
#  (https://mooseframework.inl.gov/source/userobjects/EBSDReader.html)
#  Along with a Dream3D Generated multigrain input to test the process
#  Once that works ill do blocks too-
#  For that ill need to do a two phase in dream3D i think?
#  The subtractive approach wont really work here? itd just add phi to the existing
#  ebsd in that area and doesnt want to converge/solve?
##############################################################################

[Mesh]
  [ebsd_mesh]
    type = EBSDMeshGenerator
    filename = 01_CubicSingleEquiaxedOut_testINL2D.txt
  []
  # [subdomains]
  #   type = ParsedSubdomainMeshGenerator
  #   input = ebsd_mesh
  #   combinatorial_geometry = 'x > 54'
  #   block_id = 1
  # []
[]

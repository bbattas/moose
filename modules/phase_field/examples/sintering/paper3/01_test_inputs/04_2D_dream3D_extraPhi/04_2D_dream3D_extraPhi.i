##############################################################################
# File: 04_2D_dream3D_extraPhi.i
# File Location: /examples/sintering/paper3/01_test_inputs/04_2D_dream3D_extraPhi
...
# -----
# Description:
#  Dream3D input with ebsd reader with a second phi phase added to the
#  +x direction (20 planes of dx=0.5 so 10 nm)
#  This is basically to work out how to specify things for a 2 phase txt input
#  Alternative is so use normal mesh and just manually set size and dxys the same
##############################################################################

[Mesh]
  [ebsd_mesh]
    type = EBSDMeshGenerator
    filename = test_extraPhi.txt
  []
  # [subdomains]

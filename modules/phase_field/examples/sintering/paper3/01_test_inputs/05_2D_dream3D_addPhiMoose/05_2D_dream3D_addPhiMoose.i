##############################################################################
# File: 05_2D_dream3D_addPhiMoose.i
# File Location: /examples/sintering/paper3/01_test_inputs/05_2D_dream3D_addPhiMoose
...
# -----
# Description:
#  Testing the alternate approach using the normal dream3d.txt without any phi
#  but making the mesh myself with drlmg and then adding ICs with ebsd for
#  grains and manual input for phi
#  This doesnt actually seem to let me do it without an ebsd mesh
##############################################################################

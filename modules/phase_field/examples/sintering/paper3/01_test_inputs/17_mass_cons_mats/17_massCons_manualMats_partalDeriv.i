##############################################################################
# File: 17_massCons_manualMats_partalDeriv.i
# File Location: /examples/sintering/paper3/01_test_inputs/17_mass_cons_mats
# Created Date: Wednesday August 28th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday August 28th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Testing which first derivatives are needed to keep the linear solve nice
#   so i know which ones to hard code into the GPMSMat
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../../21_multiApps_IC/05_2D_irr_tests/00_sub/04_sub_small_noIrr.i
  []
[]
...
[Modules]
  [PhaseField]
    [GrandPotentialAlt]
      ...
      hj_c_min = 'hv csueq_mask cvieq_mask csieq_mask' #cvueq_mask=hv*1 'hv_c_min hs_c_min' #cvueq_mask
    []
  []
[]
...
[Materials]
  ...
  [hoverk_vu]
    ...
    coupled_variables = 'phi' # gr0 gr1' # gr1 gr2'
    derivative_order = 1
    material_property_names = 'hv(phi) Va kvu' #(phi)
  ...
  [hoverk_su]
    ...
    coupled_variables = 'phi' # gr0' # gr1 gr2'
    derivative_order = 1
    material_property_names = 'hs(phi) Va ksu' #(phi)
  ...
  [hoverk_vi]
    ...
    coupled_variables = 'phi' # gr0' # gr1 gr2'
    derivative_order = 1
    material_property_names = 'hv(phi) Va kvi' #(phi)
  ...
  [hoverk_si]
    ...
    coupled_variables = 'phi' # gr0' # gr1 gr2'
    derivative_order = 1
    material_property_names = 'hs(phi) Va ksi' #(phi)
  ...
  [csueq_mask]
    ...
    # coupled_variables = 'phi' # gr0 gr1' # gr1 gr2'
    derivative_order = 0
    material_property_names = 'hs cv_eq' #(gr0,gr1)' #(phi)' cv_eq(gr0,gr1,gr2,gr3,gr4,gr5,gr6,gr7)'
    # constant_names = 'cb cgb'
    # constant_expressions = '3.877e-04 4.347e-03' #Irradiation
    # # constant_expressions = '2.424e-06 5.130e-03' #No Irradiation- LANL
    # expression = 'hg:=16 * ( (gr0 * gr1)^2 + (gr0 * gr2)^2 + (gr0 * gr3)^2 + (gr0 * gr4)^2 +
  ...
  [csieq_mask]
    ...
    # coupled_variables = 'phi' # gr0 gr1' # gr1 gr2'
    derivative_order = 0
    material_property_names = 'hs ci_eq' #(gr0,gr1)' #(phi)' ci_eq(gr0,gr1,gr2,gr3,gr4,gr5,gr6,gr7)'
    # constant_names = 'cb cgb'
    # constant_expressions = '7.258e-09 5.900e-06' #Irradiation
    # # constant_expressions = '1.667e-32 6.170e-08' #'1.667e-32 6.170e-08' #No Irradiation- LANL
    # # constant_expressions = '2.424e-06 5.130e-03' #No Irradiation VACANCY- LANL

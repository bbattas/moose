##############################################################################
# File: 02_hgb_noCross.i
# File Location: /examples/sintering/paper3/01_test_inputs/18_custom_irrad/02_hgb_noCross
...
# -----
# Description:
#  Using my hgb material but having removed the cross derivative terms
#
#
#
##############################################################################
...
[Materials]
  ...
  [old_hgb]
    type = ParsedMaterial
    property_name = old_hgb
    coupled_variables = 'gr0 gr1'
    material_property_names = 'hgb_man(gr0,gr1)'
    expression = 'hgb_man'
    outputs = nemesis
  []
  [new_hgb]
    type = ParsedMaterial
    property_name = new_hgb
    coupled_variables = 'gr0 gr1'
  ...
  [old_hgb_dgr0]
    type = ParsedMaterial
    property_name = old_hgb_dgr0
    coupled_variables = 'gr0 gr1'
    material_property_names = 'dhgb:=D[hgb_man(gr0,gr1),gr0]'
    expression = 'dhgb'
    outputs = nemesis
  []
  [new_hgb_dgr0]
    type = ParsedMaterial
    property_name = new_hgb_dgr0
    coupled_variables = 'gr0 gr1'
    material_property_names = 'dhgb:=D[hgb(gr0,gr1),gr0]'
    expression = 'dhgb'
    outputs = nemesis
  []
  [old_hgb_d2gr0]
  ...
  [old_hgb_dgr0gr1]
    ...
    coupled_variables = 'gr0 gr1'
    material_property_names = 'dhgb:=D[hgb_man(gr0,gr1),gr0,gr1]'
    expression = 'dhgb'
    outputs = nemesis
  []
  [new_hgb_dgr0gr1]
    type = ParsedMaterial
    property_name = new_hgb_dgr0gr1
    coupled_variables = 'gr0 gr1'
    material_property_names = 'dhgb:=D[hgb(gr0,gr1),gr0,gr1]'
    expression = 'dhgb'
    outputs = nemesis
  []
[]

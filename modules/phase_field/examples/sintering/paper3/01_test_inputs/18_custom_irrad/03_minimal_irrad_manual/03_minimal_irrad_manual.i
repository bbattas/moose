##############################################################################
# File: 03_minimal_irrad_manual.i
# File Location: /examples/sintering/paper3/01_test_inputs/18_custom_irrad/03_minimal_irrad_manual
...
# -----
# Description:
#  Trimming down the irradiation manual materials to a more minimal required
#   level based on whats needed for the custom materials
#
#
##############################################################################
...
[Kernels]
  ...
  [recombination_vac]
    ...
    variable = cvac_var
    mob_name = rho_recomb
    args = 'wvac wint cint_var phi gr0 gr1' # gr2 gr3 gr4 gr5 gr6 gr7' # grain ops mean i should include them in combined_rho
  ...
  [recombination_int]
    ...
    variable = cint_var
    mob_name = rho_recomb
    args = 'wvac wint cvac_var phi gr0 gr1' # gr2 gr3 gr4 gr5 gr6 gr7' # grain ops mean i should include them in combined_rho

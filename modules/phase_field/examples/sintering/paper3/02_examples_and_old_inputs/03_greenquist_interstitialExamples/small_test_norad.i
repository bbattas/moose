...
[Materials]
  [./constants]
    ...
    prop_names =  'Va      kmv  kbv  kmi    kbi'
    prop_values = '0.04092 26.8 26.8 3.6e21 3.6e21'
  [../]
  [./chiDv]
  ...
  [./rhov]
    type = ParsedMaterial
    f_name = rhov
    material_property_names = 'hm hb rhomv rhobv'
  ...
  [./rhoi]
    type = ParsedMaterial
    f_name = rhoi
    material_property_names = 'hm hb rhomi rhobi'

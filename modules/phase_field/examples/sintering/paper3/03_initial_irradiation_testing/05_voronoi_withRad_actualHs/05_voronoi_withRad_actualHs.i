...
# -----
# Last Modified: Tuesday November 7th 2023
...
[Materials]
  ...
  [rho_i_dpm]
    ...
    expression = 'if(int_average_rho_vac>0.0,(rho_gen / (a_r * int_average_rho_vac)),0.0)'
    outputs = 'nemesis'
  []
  # Vacancies
  [rho_gen_vac]
    ...
    material_property_names = 'hs'
    # postprocessor_names = 'hs_average'
    expression = 'f_dot * noise * Nc * Nd * hs_average * hs' # * hs
    outputs = 'nemesis'
  []
  [rho_v_recombRate]
    type = DerivativeParsedMaterial
    ...
    expression = 'a_r * rho_i_dpm * int_average_rho_vac'
    outputs = 'nemesis'
  []
  # [rho_v_recombRate]
  #   type = DerivativeParsedMaterial

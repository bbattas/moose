##############################################################################
# File: 11_08_ballisticMixing_hugeFissionRate.i
# File Location: /examples/sintering/paper3/03_initial_irradiation_testing/11_08_ballisticMixing_hugeFissionRate
...
# -----
# Description:
#  My chemical potential and vacancy concentration arent changing so Im trying
#  a much much larger fission rate to see if that does anything? 1e-2 compared
#  to the 1e-8 of normal and 1e-5 of larger (inputs 08 and 10 respectively)
#
##############################################################################
...
[Materials]
  ...
  [rho_gen_int]
    ...
    constant_expressions = '2 5 1e-2 1'
  ...
  [rho_v_mixing]
    ...
    constant_expressions = '2 268 1e-2 1 1e-11 1e12'

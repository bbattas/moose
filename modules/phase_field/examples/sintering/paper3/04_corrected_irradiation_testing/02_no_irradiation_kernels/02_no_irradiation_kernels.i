##############################################################################
# File: 02_no_irradiation_kernels.i
# File Location: /examples/sintering/paper3/04_corrected_irradiation_testing/02_no_irradiation_kernels
# Created Date: Monday November 27th 2023
...
# -----
# Description:
#  Using the new set of testing where I corrected the vacancy recombination
#  and source terms so that we we arent using hs_avg/hs_avg effectively,
#  This one with the three kernels turned off for comparison
#
##############################################################################

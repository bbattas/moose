##############################################################################
# File: 06.1_restart_test_part2.i
# File Location: /examples/sintering/paper3/04_corrected_irradiation_testing/06_restart_test
# Created Date: Tuesday January 2nd 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday January 2nd 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Testing how to do a second input restart since the --recover system
#  doesnt work with ebsd reader
#  This is the second input that should read the results of the first one
#  Commented out ebsd reader stuff
#  Need to manually set start time and dt based on checkpoint
##############################################################################

[Mesh]
  #Serial number should match corresponding Executioner parameter
  file = 06_restart_test_base_checkpoint_cp/0009-mesh.cpr
...
[Problem]
  ...
  restart_file_base = 06_restart_test_base_checkpoint_cp/0009-mesh
[]

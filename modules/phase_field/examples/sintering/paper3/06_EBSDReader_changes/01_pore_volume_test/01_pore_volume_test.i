##############################################################################
# File: 01_pore_volume_test.i
# File Location: /examples/sintering/paper3/06_EBSDReader_changes/01_pore_volume_test
# Created Date: Tuesday January 9th 2024
# Author: Battas,Brandon Scott (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday January 10th 2024
# Modified By: Battas,Brandon Scott
# -----
# Description:
#  Testing the d3d pore addition script to make sure its actually making
#  the pores the right volume percentage (they looked large in 3D)
#  This is all a 2D test
#  0.045112498 with 0.5 threshold
#  0.049843748 with 0.1 threshold
##############################################################################

[Mesh]
  [ebsd_mesh]
    type = EBSDMeshGenerator
    filename = 2D_25x25um_8umavg_test_plusVoid.txt
  []
[]

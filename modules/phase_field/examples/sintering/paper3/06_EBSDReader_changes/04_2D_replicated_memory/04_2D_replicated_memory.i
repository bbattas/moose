##############################################################################
# File: 04_2D_replicated_memory.i
# File Location: /examples/sintering/paper3/06_EBSDReader_changes/04_2D_replicated_memory
...
# -----
# Description:
#  Plotting and outputting memory usage with a replicated mesh for comparison
#  146k DoFs, so maybe like 8-10 cpus really if i wanna HPG
#  otherwise 6 local is just 25k each not bad
#
##############################################################################

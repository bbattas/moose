##############################################################################
# File: 06_2D_distributed_clFlag_memory.i
# File Location: /examples/sintering/paper3/06_EBSDReader_changes/06_2D_distributed_clFlag_memory
...
# -----
# Description:
#  Testing using the --distributed-mesh flag on the command line to see if
#  its the same as the parallel_type = DISTRIBUTED or not
#
#
##############################################################################

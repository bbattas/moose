##############################################################################
# File: 01_2D_large_no_irradiation.i
# File Location: /examples/sintering/paper3/07_large2D/01_2D_large_no_irradiation
...
# -----
# Description:
#  Large 2D D3D input (100x100+10 um with 62 grains, element size of .25um (250nm))
#  Added 7 pores equaling 6% of solid volume with minimum sep of 2*avg_pore_radius
#  No Irradiation in this case
#  2m DoFs (90~22k) (60~33k) (120~16.7k)
##############################################################################

[Mesh]
  [ebsd_mesh]
    type = EBSDMeshGenerator
    filename = 2D_100x100um_8umavg_plusVoid.txt
  []

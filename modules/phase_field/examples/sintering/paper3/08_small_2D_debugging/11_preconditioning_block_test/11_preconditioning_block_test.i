##############################################################################
# File: 11_preconditioning_block_test.i
# File Location: /examples/sintering/paper3/08_small_2D_debugging/11_preconditioning_block_test
...
# -----
# Description:
#  using asm-ilu to test what (if any) of the preconditioner block is needed
#  Pjfnk we want to minimize the off diagonals if we can, so itll be
#   either (w,phi) or no block at all hopefully and not full
#
##############################################################################

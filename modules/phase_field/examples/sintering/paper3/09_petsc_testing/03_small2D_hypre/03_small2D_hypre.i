##############################################################################
# File: 03_small2D_hypre.i
# File Location: /examples/sintering/paper3/09_petsc_testing/03_small2D_hypre
...
# -----
# Description:
#  Testing different PETSc options for speed and timestepping parameters
#
#
#
##############################################################################
...
[Executioner]
  ...
  l_max_its = 30 #100 #30 #30 #if it seems like its using a lot it might still be fine
  l_tol = 1e-04

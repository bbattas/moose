##############################################################################
# File: 06_large2D_asm_lu.i
# File Location: /examples/sintering/paper3/09_petsc_testing/06_large2D_asm_lu
# Created Date: Thursday February 1st 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Thursday February 1st 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Same, testing petsc just using the larger 2d input
...
#
#  2.1M DoFs so (150 ~14k/cpu)
##############################################################################

[Mesh]
  [ebsd_mesh]
    type = EBSDMeshGenerator
    filename = ../00_d3d_txt/2D_100x100um_8umavg_plusVoid.txt
  []
  [subdomain_external]
...
[Executioner]
  ...
  nl_max_its = 15 #20 #40 too large- optimal_iterations is 6
  l_max_its = 30 #30 #if it seems like its using a lot it might still be fine
  l_tol = 1e-04

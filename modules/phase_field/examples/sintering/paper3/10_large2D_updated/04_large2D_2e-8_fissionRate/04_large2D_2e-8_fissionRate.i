##############################################################################
# File: 04_large2D_2e-8_fissionRate.i
# File Location: /examples/sintering/paper3/10_large2D_updated/04_large2D_2e-8_fissionRate
# Created Date: Friday February 2nd 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Friday February 2nd 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Large 2D with the new petsc options (asm-ilu), WITH irradiation kernels
#   Fission rate of 2e-8 instead of 1e-8
...
[Materials]
  ...
  [rho_gen_int]
    ...
    constant_expressions = '2 5 2e-8 1'
  ...
  [rho_v_mixing]
    ...
    constant_expressions = '2 268 2e-8 1 1e-11 1e12'

##############################################################################
# File: 01_test_1.i
# File Location: /examples/sintering/paper3/11_2D_square_pore_debugging/01_test_1
# Created Date: Tuesday February 6th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday February 6th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Debugging output of the small 2D D3D input to run longer to try to find
#   why the pores in the large_2D inputs turned square???
#  Considering things like: mesh, interface mobility (L), and diffusivity
#
##############################################################################

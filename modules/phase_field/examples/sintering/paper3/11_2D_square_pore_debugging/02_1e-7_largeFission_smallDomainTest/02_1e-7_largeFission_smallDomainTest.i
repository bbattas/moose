##############################################################################
# File: 02_1e-7_largeFission_smallDomainTest.i
# File Location: /examples/sintering/paper3/11_2D_square_pore_debugging/02_1e-7_largeFission_smallDomainTest
# Created Date: Wednesday February 7th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday February 7th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Teting to make sure the small sample has the square pore problem by using the
#   high fission rate that caused it to happen the fastest
#
#
##############################################################################
...
[Materials]
  ...
  [rho_gen_int]
    ...
    constant_expressions = '2 5 1e-7 1'
  ...
  [rho_v_mixing]
    ...
    constant_expressions = '2 268 1e-7 1 1e-11 1e12'

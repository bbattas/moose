##############################################################################
# File: 09_1e-7_fission_fineMesh.i
# File Location: /examples/sintering/paper3/11_2D_square_pore_debugging/09_1e-7_fission_fineMesh
# Created Date: Friday February 9th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Friday February 9th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  The uniform_refine = 1 seemed to solve the square grains on the no irradiation
#   so this is the high fission rate with the UR=1 to see if it is fixed too
#
#
##############################################################################

##############################################################################
# File: 01_hs_int_vs_vac.i
# File Location: /examples/sintering/paper3/13_defect_irradiation_debugging/01_hs_int_vs_vac
# Created Date: Tuesday February 13th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday February 13th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Changing the hs vs hs_avg usage in the vac/int calcs.
#  Was using hs_average in rhoi but need to seperate it so i can use the
#   actual hs*rhoi in the rhov calcs while the rhoi uses hs_avg still
#
##############################################################################

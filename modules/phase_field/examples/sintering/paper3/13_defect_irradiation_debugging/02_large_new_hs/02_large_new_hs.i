##############################################################################
# File: 02_large_new_hs.i
# File Location: /examples/sintering/paper3/13_defect_irradiation_debugging/02_large_new_hs
...
# -----
# Description:
#  Using the large 2d input from previous tests but using the new hs
#   setup/interstitial implementation that i used in input 01 to see that
#   its actually working longer and larger
#
##############################################################################

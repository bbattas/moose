...
# -----
# Last Modified: Thursday February 15th 2024
...
[ScalarKernels]
  ...
  [rhoi_rest]
    ...
    expression = '-(Nc*Nd*f_dot*hs_average - average_rho_vac*rhoi_scalar*a_r_pp)' #-
    variable = rhoi_scalar
    postprocessors = 'hs_average average_rho_vac a_r_pp'

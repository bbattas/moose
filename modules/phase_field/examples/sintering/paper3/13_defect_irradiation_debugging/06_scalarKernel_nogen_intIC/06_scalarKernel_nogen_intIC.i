##############################################################################
# File: 06_scalarKernel_nogen_intIC.i
# File Location: /examples/sintering/paper3/13_defect_irradiation_debugging/06_scalarKernel_nogen_intIC
# Created Date: Tuesday February 20th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday February 20th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Testing what happens if i give rho_i an IC value > 0 and then use only the
#   annhilation/recombination part/kernels and not the generation.
#  It should decrease defect values until int reaches 0 and then stay there.
#  It does: drops fast then fluctuates +/- 1e-40 to 1e-168 or so
##############################################################################
...
[Variables]
  ...
  [rhoi_scalar]
    family = SCALAR
    order = FIRST
    initial_condition = 0.05 #0.05 #0.01
  []
[]
...
[ScalarKernels]
  ...
  [rhoi_rest]
    ...
    expression = 'average_rho_vac*rhoi_scalar*a_r_pp' #hs_rhov_avg
    variable = rhoi_scalar

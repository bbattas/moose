##############################################################################
# File: 07_scalarKernel_genOnly.i
# File Location: /examples/sintering/paper3/13_defect_irradiation_debugging/07_scalarKernel_genOnly
...
# -----
# Description:
#  Testing the opposite of the annihiltion only, do both vac anc int increase with
#   only the generation kernels on?
#
#
##############################################################################

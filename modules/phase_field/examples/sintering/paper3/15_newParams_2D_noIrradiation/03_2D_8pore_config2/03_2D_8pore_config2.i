##############################################################################
# File: 03_2D_8pore_config2.i
# File Location: /examples/sintering/paper3/15_newParams_2D_noIrradiation/03_2D_8pore_config2
...
# -----
# Description:
#  New large 2D IC #2 (8 pores, 6% volume, 2.5r minimum separation)
...
[Mesh]
  [ebsd_mesh]
    ...
    filename = ../../14_large_2D_noIrradiation/00_d3d_txt/2D_100x100um_8umavg_config2_8pore.txt
  []
  [subdomain_external]
...
[Outputs]
  ...
  [csv]
    type = CSV
    file_base = 03_2D_8pore_config2_csv/03_2D_8pore_config2
    time_step_interval = 3
  []
  [nemesis]
    type = Nemesis
    file_base = 03_2D_8pore_config2_nemesis/03_2D_8pore_config2_nemesis
  ...
  [checkpoint]
    type = Checkpoint
    file_base = 03_2D_8pore_config2_checkpoint
    num_files = 5
  []
[]

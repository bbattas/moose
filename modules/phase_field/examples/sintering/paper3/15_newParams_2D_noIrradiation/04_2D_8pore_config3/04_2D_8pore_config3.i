##############################################################################
# File: 04_2D_8pore_config3.i
# File Location: /examples/sintering/paper3/15_newParams_2D_noIrradiation/04_2D_8pore_config3
...
# -----
# Description:
#  New large 2D IC #23(8 pores, 6% volume, 2.5r minimum separation)
...
[Mesh]
  [ebsd_mesh]
    ...
    filename = ../../14_large_2D_noIrradiation/00_d3d_txt/2D_100x100um_8umavg_config3_8pore.txt
  []
  [subdomain_external]
...
[Outputs]
  ...
  [csv]
    type = CSV
    file_base = 04_2D_8pore_config3_csv/04_2D_8pore_config3
    time_step_interval = 3
  []
  [nemesis]
    type = Nemesis
    file_base = 04_2D_8pore_config3_nemesis/04_2D_8pore_config3_nemesis
  ...
  [checkpoint]
    type = Checkpoint
    file_base = 04_2D_8pore_config3_checkpoint
    num_files = 5
  []
[]

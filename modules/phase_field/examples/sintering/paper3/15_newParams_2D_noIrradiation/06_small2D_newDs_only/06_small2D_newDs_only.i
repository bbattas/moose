##############################################################################
# File: 06_small2D_newDs_only.i
# File Location: /examples/sintering/paper3/15_newParams_2D_noIrradiation/06_small2D_newDs_only
...
# -----
# Description:
#  Part of testing the various new components to see if they cause the same
#   issue i had in the large 2D case with all of them
#
#
##############################################################################
...
[Materials]
  ...
  [chiD]
    ...
    T = T
    D0 = 8.33e9
    GBmob0 = 1.4759e9 #3.42828e10 # nm4/eVs #1.4759e9 # new value from Tonks/PC/Jake GG Paper
    Q = 2.77 #3.01 #2.77 # new value from Tonks/PC/Jake GG Paper
    Em = 3.608
    bulkindex = 1

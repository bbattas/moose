##############################################################################
# File: 09_small2D_newDs_GBmob_SGBenergiesEqual.i
# File Location: /examples/sintering/paper3/15_newParams_2D_noIrradiation/09_small2D_newDs_GBmob_SGBenergiesEqual
...
# -----
# Description:
#  same as 06/07, just using new Ds and new GB mobility AND the new surface/gb
#   energies, where the surface = gb, since some of alis work has shown that
#   can be fine for uo2 sintering especially
#
##############################################################################

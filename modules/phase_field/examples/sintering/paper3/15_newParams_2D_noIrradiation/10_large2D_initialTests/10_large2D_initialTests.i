##############################################################################
# File: 10_large2D_initialTests.i
# File Location: /examples/sintering/paper3/15_newParams_2D_noIrradiation/10_large2D_initialTests
...
# -----
# Description:
#  Trying to recreate the initial issue i had with this large 2D input
#  Using all the new params, possibly toggling some of them to see
#   what causes or fixes the issue
#  The surface D is a little higher than it was in that failed run now
##############################################################################
...
[Mesh]
  [ebsd_mesh]
    ...
    filename = ../../14_large_2D_noIrradiation/00_d3d_txt/2D_100x100um_8umavg_config1_8pore.txt
  []
  [subdomain_external]
...
[ICs]
  ...
  [voidIC2]
    ...
    invalue = 1
    outvalue = 0.01
    radii = '4044.55 4605.3  6214.76 5184.68 4946.83 4730.66 4716.08 4338.55'
    x_positions = '44295.57 20174.13 77228.66 53033.03 50571.93 23436.57 78406.12 68446.06'
    y_positions = '20906.12 68584.76 44108.32 70048.19 44903.33 33916.61 70057.88 20328.92'

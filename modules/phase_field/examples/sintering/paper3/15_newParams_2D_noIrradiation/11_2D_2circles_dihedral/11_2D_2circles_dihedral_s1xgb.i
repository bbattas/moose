##############################################################################
# File: 11_2D_2circles_dihedral_s1xgb.i
# File Location: /examples/sintering/paper3/15_newParams_2D_noIrradiation/11_2D_2circles_dihedral
# Created Date: Saturday April 6th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Saturday April 6th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Testing a 2 circle in space IC to look at dihedral angle with changing
#   the surface vs gb energy ratio with all the new parameters
#  This is surface energy = 1x gb energy
#
##############################################################################
...
[ICs]
  ...
  [voidIC]
    ...
    outvalue = 1 #0.01
    radii = '5200 5200'
    x_positions = '10000 20000'
    y_positions = '10000 10000'
    z_positions = '0 0'
    block = 0
  []
[]

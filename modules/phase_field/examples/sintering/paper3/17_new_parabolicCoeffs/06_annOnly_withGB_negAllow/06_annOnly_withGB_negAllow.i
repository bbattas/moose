##############################################################################
# File: 06_annOnly_withGB_negAllow.i
# File Location: /examples/sintering/paper3/17_new_parabolicCoeffs/06_annOnly_withGB_negAllow
...
# -----
# Description:
#  Testing the new parabolic coefficients using 5%vol
#  With irradiation just at the 1e-8 fission rate ONLY ANN with gb ON
#  This one im also removing the if statement that keeps the value for recomb positive
#
##############################################################################

##############################################################################
# File: 08_bicrystal_recombTests.i
# File Location: /examples/sintering/paper3/17_new_parabolicCoeffs/08_bicrystal_recombTests
...
# -----
# Description:
#  Using a BicrystalBoundingBoxICAction to generate a simple bicrystal with
#   a square grain inside another square grain
#  Small simple test for keeping ceq at th_eq and trying to push the value to
#   the irradiation values by adjusting recombination primarily
##############################################################################

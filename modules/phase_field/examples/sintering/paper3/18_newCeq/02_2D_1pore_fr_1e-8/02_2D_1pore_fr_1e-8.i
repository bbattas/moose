##############################################################################
# File: 02_2D_1pore_fr_1e-8.i
# File Location: /examples/sintering/paper3/18_newCeq/02_2D_1pore_fr_1e-8
...
# -----
# Description:
#  Fist test using fission for the different ceq (and associated k) for
#   irradiation with the d3d 2D input with one big pore in the center
#  Using the 5% GB volume version of parabolic coeffs for 1600K
#  Might widen the GB actual width based on LANL DFT?
##############################################################################

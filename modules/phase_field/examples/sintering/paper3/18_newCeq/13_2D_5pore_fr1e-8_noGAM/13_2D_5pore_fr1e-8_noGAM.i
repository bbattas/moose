##############################################################################
# File: 13_2D_5pore_fr1e-8_noGAM.i
# File Location: /examples/sintering/paper3/18_newCeq/13_2D_5pore_fr1e-8_noGAM
...
# -----
# Description:
#  Disabled generation annhilation and mixing, so NO IRR KERNELS but using irr
#   ceqs and ks
#  Using 07 hshv where hs and hv in the combined rhovac and rhoint instead of
#   hv and 1-hv
##############################################################################

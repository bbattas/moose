##############################################################################
# File: 01_2D_2grain_circles.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/01_2D_2grain_circles
# Created Date: Tuesday June 4th 2024
# Author: Battas,Brandon Scott (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday June 4th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Concerned about mass loss (seen in cv integral for example) as GG happens.
#  As GB grows the cv-eq changes as a function of GB vs Bulk
#
#
##############################################################################
...
[GlobalParams]
  op_num = 2
  var_name_base = gr
  int_width = 20 #1000 #min radius is like 2250, element size of 250
...
[Materials]
  ...
  [cv_eq]
    ...
    property_name = cv_eq
    coupled_variables = 'gr0 gr1 phi T wvac' #gr2
  ...
  [combined_rho_vac]
    ...
    derivative_order = 2
    material_property_names = 'rhov(wvac) rhos(wvac) hv(phi)'
...
[Modules]
  [PhaseField]
    [GrandPotential]
      ...
      mobilities = 'chiD' # chiiD'
      susceptibilities = 'chi' # chii'
      free_energies_w = 'rhov rhos' # rhovi rhosi'

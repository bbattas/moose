##############################################################################
# File: 03_GP3phase_masscons_gbceq.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/03_GP3phase_masscons_gbceq
...
# -----
# Description:
# Testing a variation using different ceq on gb vs bulk
#
...
[Materials]
  ...
  [const] #renamed constant value ceqs to _c
    ...
    prop_names = 'kappa_c  kappa   L   D    Vm   ka    caeq_c kb    cbeq_c  kd    cdeq_c  gab gad gbd  mu  tgrad_corr_mult'

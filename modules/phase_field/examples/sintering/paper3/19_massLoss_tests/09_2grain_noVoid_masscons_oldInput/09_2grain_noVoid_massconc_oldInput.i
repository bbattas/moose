##############################################################################
# File: 09_2grain_noVoid_massconc_oldInput.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/09_2grain_noVoid_masscons_oldInput
...
# -----
# Description:
#  Used 02_GP3phase_masscons but with the 2 grain IC structure to see it it
#   has the same issue im seeing where even constant ceq is causing mass loss
#   still?
#
##############################################################################

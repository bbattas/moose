##############################################################################
# File: 12_2D_simpleD3D_masscons.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/12_2D_simpleD3D_masscons
...
# -----
# Description:
#  Test of mass conservation on our system
#  Uses only sintering side of stuff (no GAM), and thermal ceq and ks
#  Uses mass conservation stuff here
#  65k DoFs
#
# NOT WORKING??? might be the C_ics that are causing the issue? it also every
#  linear step is forced to output the Finished Computing Residual with like
#  7 seconds for every linear which isnt good.  Gonna try this but with only
#  vacancies to see if it works simpler. Might need like multiapps or something?
##############################################################################

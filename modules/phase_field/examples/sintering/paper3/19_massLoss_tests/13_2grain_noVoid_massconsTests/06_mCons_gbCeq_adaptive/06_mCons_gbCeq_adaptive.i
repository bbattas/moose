##############################################################################
# File: 06_mCons_gbCeq_adaptive.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/13_2grain_noVoid_massconsTests/06_mCons_gbCeq_adaptive
...
#  This is WITH mass conservation and using GB/Bulk dependent ceq
#  UR: 0 = ~15k, 1 = ~60k, 2 = ~240k
#  This is using an adaptive timestepper
##############################################################################

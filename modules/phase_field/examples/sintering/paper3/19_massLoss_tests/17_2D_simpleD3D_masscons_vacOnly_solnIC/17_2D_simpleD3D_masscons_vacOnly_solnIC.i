##############################################################################
# File: 17_2D_simpleD3D_masscons_vacOnly_solnIC.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/17_2D_simpleD3D_masscons_vacOnly_solnIC
...
# -----
# Description:
#  Trying loading a solution IC for c IC in vacancy only mass conservation
#   with a small 3 grain 1 pore D3D Input
#
#
##############################################################################
...
[Materials]
  ...
  [cvac]
    ...
    outputs = none #nemesis #none #exodus
  []
  [cint]
    type = ParsedMaterial
    property_name = cint
...
[UserObjects]
  ...
  [exo_soln]
    ...
    mesh = '17_icGenTest_out.e'
    system_variables = 'cv_aux'
    timestep = LATEST
    # force_preic = true
  []
[]

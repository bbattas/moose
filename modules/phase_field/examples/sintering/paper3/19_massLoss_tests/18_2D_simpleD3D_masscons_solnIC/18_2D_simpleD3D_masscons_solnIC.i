##############################################################################
# File: 18_2D_simpleD3D_masscons_solnIC.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/18_2D_simpleD3D_masscons_solnIC
...
#  65k DoFs
#  Using solutionIC from a 1 timestep file to create the c ICs
##############################################################################
...
[UserObjects]
  ...
  [exo_soln]
    ...
    mesh = 'IC_gen/18_IC_gen_out.e'
    system_variables = 'cv_aux ci_aux'
    timestep = LATEST
    # force_preic = true
  []
[]

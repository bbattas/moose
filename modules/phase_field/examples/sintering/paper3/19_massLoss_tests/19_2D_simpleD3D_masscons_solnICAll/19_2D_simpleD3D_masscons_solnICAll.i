##############################################################################
# File: 19_2D_simpleD3D_masscons_solnICAll.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/19_2D_simpleD3D_masscons_solnICAll
...
#  65k DoFs
#  Using solutionIC from a 1 timestep file to create ALL OF THE ICs
##############################################################################
...
[ICs]
  ...
  [IC_gr2]
    ...
    block = '0 1'
  []
  # C coming from solution user object
  [IC_cv]
    type = SolutionIC
    solution_uo = exo_soln
    variable = cv_cons
    from_variable = 'cv_aux'
    block = '0 1'
  []
  [IC_ci]
    type = SolutionIC
...
[UserObjects]
  ...
  [exo_soln]
    ...
    mesh = 'IC_gen/19_IC_gen_out.e'
    system_variables = 'cv_aux ci_aux phi gr0 gr1 gr2'
    timestep = LATEST
    # force_preic = true
  []
[]

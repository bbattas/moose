##############################################################################
# File: 19_IC_gen.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/19_2D_simpleD3D_masscons_solnICAll/IC_gen
...
# -----
# Description:
#  Multiple timestep simulation to create solution IC for cv and ci and grs/phi
#  copy of 18_2D_simpleD3D_masscons_solnIC with less stuff
#   No csv out (no PPs/VPPs) and exodus instead of nemesis
#
##############################################################################
...
[Materials]
  ...
  [densificaiton]
    ...
    mass_conservation = false #ADDED THIS
  []

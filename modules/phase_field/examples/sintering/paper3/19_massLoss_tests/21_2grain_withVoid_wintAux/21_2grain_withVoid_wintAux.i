##############################################################################
# File: 21_2grain_withVoid_wintAux.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/21_2grain_withVoid_wintAux
...
# -----
# Description:
#  Testing input 20 but using the vacancy and interstitial formulation, but
#   with interstitials as an auxvariable and not in the calculation
#  Checking that all the irradiation/2defect based materials seem to work still
#
##############################################################################

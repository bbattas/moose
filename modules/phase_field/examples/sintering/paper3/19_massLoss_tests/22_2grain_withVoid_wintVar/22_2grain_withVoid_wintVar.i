##############################################################################
# File: 22_2grain_withVoid_wintVar.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/22_2grain_withVoid_wintVar
...
# -----
# Description:
#  Input 20/21 but using wvac and wint as variables, both with mass conservation
#  BUT no interaction between them (no GAM)
#
#
##############################################################################

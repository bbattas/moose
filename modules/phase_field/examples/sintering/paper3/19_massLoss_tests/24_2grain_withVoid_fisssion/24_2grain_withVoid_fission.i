##############################################################################
# File: 24_2grain_withVoid_fission.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/24_2grain_withVoid_fisssion
...
#  This input is using all the non-irradiation values (ceq and k)!
#
##############################################################################
...
[Kernels]
  ...
  [recombination_vac]
    ...
    variable = wvac
    mob_name = rho_recomb
    args = 'wint phi gr0 gr1' # gr0 gr1 gr2'
  ...
  [recombination_int]
    ...
    variable = wint
    mob_name = rho_recomb
    args = 'wvac phi gr0 gr1' # gr0 gr1 gr2'
...
[Materials]
  ...
  [rho_recomb]
    ...
    material_property_names = 'a_r(phi,gr0,gr1) combined_rho_vac(wvac,phi,gr0,gr1) combined_rho_int(wint,phi,gr0,gr1)'

##############################################################################
# File: 26_2grain_withVoid_partialIrrTesting.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/26_2grain_withVoid_partialIrrTesting
...
# -----
# Description:
#  Using the input 25 (with 0.01xR), but trying gen/recomb independently to
#   see if they are actually changing things? since the cv/ci didnt seem to
#   change in the last test at least total.
#  Concerned mass conservation wont work with fission?
##############################################################################

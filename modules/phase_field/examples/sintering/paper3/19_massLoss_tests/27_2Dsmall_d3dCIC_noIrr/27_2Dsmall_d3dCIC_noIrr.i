##############################################################################
# File: 27_2Dsmall_d3dCIC_noIrr.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/27_2Dsmall_d3dCIC_noIrr
# Created Date: Wednesday June 19th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday June 19th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  First test of real d3d input using the new IC that reads concentrations
#  No irradiation (TH_EQ)
#  The IC at least works, but the solve gets weird.  conc vars get negative
#   ci especially, and the grain OPs stay jagged/sharp for a long time
##############################################################################

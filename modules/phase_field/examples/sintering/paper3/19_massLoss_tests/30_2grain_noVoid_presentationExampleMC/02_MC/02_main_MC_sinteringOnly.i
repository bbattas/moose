##############################################################################
# File: 01_main_MC_sinteringOnly.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/02_buildup/01_sinteringOnly
...
# -----
# Description:
#  Parent file for a vacancy/sintering only test, first level of the buildup
#
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 02_sub_NMC_sinteringOnly_1step.i
  []
[]

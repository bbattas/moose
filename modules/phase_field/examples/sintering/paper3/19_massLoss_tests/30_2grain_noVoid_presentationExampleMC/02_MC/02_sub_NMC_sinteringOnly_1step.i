##############################################################################
# File: 02_sub_NMC_sinteringOnly_1step.i
# File Location: /examples/sintering/paper3/19_massLoss_tests/30_2grain_noVoid_presentationExampleMC/02_MC
# Created Date: Sunday August 18th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Sunday August 18th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  subfile for MC version of the simple input as an example for a presentation
#
#
#
##############################################################################
...
[Functions]
  [ic_func_gr0] # Left grain
    ...
    symbol_values = '1000 -5000 7500 15000 30000'
  ...
  [ic_func_gr1] # Right grain
    ...
    symbol_names = 'iw x0 y0 r xr'
    symbol_values = '1000 -5000 7500 15000 30000'
    expression = 'd:=sqrt((x-x0)^2+(y-y0)^2);0.5*(1.0-tanh((r-d)/iw)) * 0.5*(1.0-tanh((x-xr)/iw))'
  []
  [ic_func_phi] # Right grain
    type = ParsedFunction
    symbol_names = 'iw x0 y0 r xr'
    symbol_values = '1000 -5000 7500 15000 30000'
    expression = '1 - 0.5*(1.0-tanh((x-xr)/iw))'
  []
[]

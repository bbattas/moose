##############################################################################
# File: 13_sintering_vOnly.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/13_sintering_vOnly
...
#   so this is using the sintering verison with no interstitials for comparison
#   to see if that still happens or if its maybe something in one of my materials
#   for the dual vac-int system?
##############################################################################

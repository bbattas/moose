##############################################################################
# File: 15_sintering_NMC.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/15_sintering_NMC
# Created Date: Thursday July 11th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday July 17th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Sintering vac only test with No mass conservation for comparison?
#  Of note, the elements are not technically square? like theyre
#   666 in x and 500 in y (before refine) if that matters?- corrected to square
#
#  I left the cvac_var in but it doesnt evolve like this (see GB)
##############################################################################
...
[Kernels]
  ...
  [ChiDt_wvac]
    ...
    variable = wvac
    f_name = chiu
    coupled_variables = 'phi gr0 gr1 wvac' #wint #not sure it needs wint since theyre independent?
  []
  [MatDif_wvac]
    type = MatDiffusion
    variable = wvac
    diffusivity = chiuD
    args = 'phi gr0 gr1 wvac' #wint#not sure it needs wint since theyre independent?
  []

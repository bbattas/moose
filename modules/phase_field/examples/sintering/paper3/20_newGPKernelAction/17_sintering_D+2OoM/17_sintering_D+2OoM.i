##############################################################################
# File: 17_sintering_D+2OoM.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/17_sintering_D+2OoM
...
# -----
# Description:
#  Trying to test things to see what is causing the separated rings in chempot
#  This is trying an increase in all D by 2 OoM (bulk and surface really though)
#   GB is manual at teh moment, but bulk i can scale up prefactor and use 1e10
#   for surf to be ~1OoM over the normal plus 2 on base means about:
#   Bulk x 1e2, GB x 1, Surf x 1e3
##############################################################################

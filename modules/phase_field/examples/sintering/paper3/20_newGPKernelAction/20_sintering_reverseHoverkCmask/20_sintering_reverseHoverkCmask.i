##############################################################################
# File: 20_sintering_reverseHoverkCmask.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/20_sintering_reverseHoverkCmask
...
# -----
# Description:
#  Signage adjustments again, setting the w of c mob back to -1 like its supposed to
#   be, but setting the hoverk and cmasks to - to see if thats the same effect
#   as just the mob at +1 instead of -1?
#
##############################################################################

##############################################################################
# File: 22_sintering_kvol.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/22_sintering_kvol
# Created Date: Tuesday July 16th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday July 16th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Using the 5% volume approximation for kvac instead of the gb value?
#
#
#
##############################################################################
...
[Materials]
  ...
  [k_constants]
    ...
    prop_values = '1.302e4 1.302e4 1.302e4 1.302e4' # No Irr- Vac 5% Volume Approx
  []
  [gb_e_mat] # eV/nm^2
    type = ParsedMaterial

##############################################################################
# File: 27_sintering_wideDomain.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/27_sintering_wideDomain
...
# -----
# Description:
#  Increasing the domain size of my input in the y axis so the outer edge of
#   the cv ring around solid-void pore doesnt exit the domain?
#
#
##############################################################################

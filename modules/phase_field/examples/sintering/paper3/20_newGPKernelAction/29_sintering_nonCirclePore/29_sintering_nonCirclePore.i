##############################################################################
# File: 29_sintering_nonCirclePore.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/29_sintering_nonCirclePore
...
# -----
# Description:
#  Creating 2 subblocks on the right so i can move the circle to more of a
#   lenticular/oval shape? see if that keeps the pore from causing the problem?
#
#
##############################################################################

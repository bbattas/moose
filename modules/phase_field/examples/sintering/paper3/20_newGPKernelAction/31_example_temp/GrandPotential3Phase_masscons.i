##############################################################################
# File: GrandPotential3Phase_masscons.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/31_example_temp
# Created Date: Friday July 19th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Friday July 19th 2024
...
[Materials]
  ...
  [const]
    ...
    prop_values = '0        1       1.0 1.0  1.0  10.0  1  10.0  0.9   10.0  2.424e-06   1.5 1.5 1.5  1.0 0.0'
  []
  [Mobility]
    type = DerivativeParsedMaterial
  ...
  [chiDu_out]
    type = ParsedMaterial
    property_name = chiDu_out
    material_property_names = 'DchiVm'
    expression = 'DchiVm'
    outputs = 'exodus'
  []
  [cvac]
    type = ParsedMaterial
    property_name = cvac
    material_property_names = 'ha hd rhoa rhod'
    expression = 'ha*rhoa + hd*rhod'
    outputs = 'exodus'
  []
[]

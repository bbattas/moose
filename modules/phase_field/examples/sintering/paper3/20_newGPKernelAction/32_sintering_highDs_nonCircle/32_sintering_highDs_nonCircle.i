##############################################################################
# File: 32_sintering_highDs_nonCircle.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/32_sintering_highDs_nonCircle
# Created Date: Saturday July 20th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Saturday July 20th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Running with a high Ds and bulk=vapor on the lenticular pore input
#  Want to see if this maybe lets it resolve the solid-void interface Cv weirdness
#   that happens, since it seemed to go away quickly on constant D tests at least
#
##############################################################################

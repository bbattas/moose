##############################################################################
# File: 36_sintering_highBulkC.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/36_sintering_highBulkC
# Created Date: Sunday July 21st 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Sunday July 21st 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Checking what happens if theres a less extreme concentration difference
#   between bulk and void/gb bu increasing bulk C to = gb C
#
#
##############################################################################
...
[ICs]
  ...
  [cv_IC_TR]
    ...
    radius = 5000
    invalue = 1
    outvalue = 5.130e-3 #2.424e-06 #3.877e-04
    block = 1
  []
  [cv_IC_BR]
    type = SmoothCircleIC
...
[Functions]
  ...
  [ic_func_cvGB]
    ...
    symbol_values = '2000 -5000 7500 15000 5.130e-03 5.130e-03' #2.424e-06 5.130e-03' #3.877e-04 4.347e-03' # irr
...
[Materials]
  ...
  [cv_eq]
    ...
    constant_expressions = '5.130e-03 5.130e-03' #No Irradiation- LANL

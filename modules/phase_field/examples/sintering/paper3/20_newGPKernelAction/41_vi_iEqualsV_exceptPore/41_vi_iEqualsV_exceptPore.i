##############################################################################
# File: 41_vi_iEqualsV_exceptPore.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/41_vi_iEqualsV_exceptPore
# Created Date: Friday July 26th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Monday July 29th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  same as the last input where ints = vacancies but this one has the correct
#   pore concentrations (1 vac - 0 int)
#  D is manually scaled close to what the vac values are for gb and surf so
#   ints can be the same
##############################################################################
...
[Outputs]
  ...
  exodus = true
  checkpoint = false
  file_base = 41_iPore0_ciIW_400_UR1
[]

##############################################################################
# File: 42_vi_Dequal_ciNormal.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/42_vi_Dequal_ciNormal
# Created Date: Monday July 29th 2024
...
# -----
# Description:
#  Next step: using the same D for both phases but switching the solid phase
#   ci back to its actual values (using vac k for vac and int still though)
#
#
##############################################################################

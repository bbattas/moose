##############################################################################
# File: 45_vi_allNormal_hgbifForBlockBoundary.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/45_vi_allNormal_hgbifForBlockBoundary
...
# -----
# Description:
#  Full NMC problem with int and vac different BUT using a lower limit if in the
#   hgb in both IC and material to deal with the int c value ranging too many OOM
#   so it was being messed up on block boundary and drifting across whole domain
#
##############################################################################

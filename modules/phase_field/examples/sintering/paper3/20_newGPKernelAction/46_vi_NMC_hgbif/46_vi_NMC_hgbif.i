##############################################################################
# File: 46_vi_NMC_hgbif.i
# File Location: /examples/sintering/paper3/20_newGPKernelAction/46_vi_NMC_hgbif
...
# -----
# Description:
#  Input 45 using the hgb if lower limit but without mass cons to compare
#
#
#
##############################################################################
...
[Kernels]
  ...
  [Coupled_wvac_phi]
    ...
    variable = wvac
    v = 'phi'
    coupled_variables = 'phi gr0 gr1 wvac wint' #wint
    hj_names = 'hv hs'

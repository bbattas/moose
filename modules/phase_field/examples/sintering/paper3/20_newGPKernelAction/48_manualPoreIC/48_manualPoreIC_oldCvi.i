...
# -----
# Description:
#  Same as the other input 48 with a manually defined pore, but using the
#  phi function for concentrations too instead of hv for comparison of the
...
[Functions]
  ...
  #   hv*cp + (1-hv)*cb'
  # []
  # Phi version instead of hv version
  [ic_func_cvPore] # Right side pore
    type = ParsedFunction
    symbol_names = 'iw x0 y0 r cb cp'
    symbol_values = '1000 30000 7500 5000 2.424e-06 1'

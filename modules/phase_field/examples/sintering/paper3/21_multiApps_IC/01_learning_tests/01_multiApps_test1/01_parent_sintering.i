##############################################################################
# File: 01_parent_sintering.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/01_learning_tests/01_multiApps_test1
...
# -----
# Description:
#  First attempt at multapps parent to take the end result of 01_sub as the IC
#
#
#
##############################################################################
...
[MultiApps]
  ...
  [full_solve]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 01_sub_sintering.i
  []
[]
...
[Transfers]
  ...
  [from_sub]
    ...
    source_variable = 'gr0 gr1 phi'
    variable = 'gr0 gr1 phi'
  []
[]

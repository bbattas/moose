##############################################################################
# File: 02_MC_parent_sintering.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/01_learning_tests/02_sintering_cvac
...
# -----
# Description:
#  Parent/main/master input testing passing the cvac material to a variable IC
#
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 02_NMC_sub_sintering.i
  []
[]
...
[Transfers]
  [from_NMC]
    ...
    source_variable = 'gr0 gr1 phi cvac'

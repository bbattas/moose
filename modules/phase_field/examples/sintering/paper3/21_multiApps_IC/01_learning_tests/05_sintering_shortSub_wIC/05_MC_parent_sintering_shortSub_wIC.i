##############################################################################
# File: 05_MC_parent_sintering_shortSub_wIC.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/01_learning_tests/05_sintering_shortSub_wIC
...
# -----
# Description:
#  Same as the other one but ALSO passing over w from the NMC instead of using
#  an IC of 0
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 05_NMC_sub_sintering_shortSub_wIC.i
  []
[]
...
[Transfers]
  [from_NMC]
    ...
    source_variable = 'gr0 gr1 phi cvac_aux wvac'
    variable = 'gr0 gr1 phi cvac_var wvac'
  []
[]

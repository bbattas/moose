##############################################################################
# File: 06_MC_parent_sintering_longSub_noWIC.i
...
# -----
# Description:
#  Running the subfile longer (100s) before passing the values over
#
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 06_NMC_sub_sintering_longSub_noWIC.i
  []
[]

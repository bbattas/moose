##############################################################################
# File: 07_MC_parent_sintering_longSub_wIC.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/01_learning_tests/07_sintering_longSub_wIC
...
# -----
# Description:
#  pulling from subfile after 100s AND pulling the w value instead of using
#   IC = 0
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 07_NMC_sub_sintering_longSub_wIC.i
  []
[]

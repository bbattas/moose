##############################################################################
# File: 02_main_MC_vi_iEqualsV_exceptPore.i
...
# -----
# Description:
#  Parent/main file for MC testing of both vac and int where int = vac except
#   for the ceq in the pore (i=0 v=1)
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 02_sub_NMC_vi_iEqualsV_exceptPore_1step.i
  []
[]

##############################################################################
# File: 02_sub_NMC_vi_iEqualsV_exceptPore_1step.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/02_buildup/02_vi_iEqualsV_exceptPore
# Created Date: Tuesday August 6th 2024
# Author: Battas,Brandon Scott (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday August 6th 2024
# Modified By: Battas,Brandon Scott
# -----
# Description:
#  Subfile for 1 timestep of a densification (vac and int) problem using
#   the vacancy D and concentrations and k for int except pore ceq = 0 for int
#  Using manual D OOMs so theyre equal
#
##############################################################################

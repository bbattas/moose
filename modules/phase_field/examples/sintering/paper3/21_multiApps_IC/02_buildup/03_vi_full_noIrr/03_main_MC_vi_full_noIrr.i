##############################################################################
# File: 03_main_MC_vi_full_noIrr.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/02_buildup/03_vi_full_noIrr
...
# -----
# Description:
#  Full Normal vac and int system without any irradiation
#
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 03_sub_NMC_vi_full_noIrr_1step.i
  []
[]

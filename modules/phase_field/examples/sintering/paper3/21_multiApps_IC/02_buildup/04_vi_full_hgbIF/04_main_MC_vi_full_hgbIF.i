##############################################################################
# File: 04_main_MC_vi_full_hgbIF.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/02_buildup/04_vi_full_hgbIF
...
# -----
# Description:
#  Testing a lower threshold on the hgb material so that the interstitial conc
#   can actually get to the bulk value, otherwise cgb overpowers it even when
#   hgb is like 1e-8 or lower
#  Full main input here
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 04_sub_NMC_vi_full_hgbIF_1step.i
  []
[]

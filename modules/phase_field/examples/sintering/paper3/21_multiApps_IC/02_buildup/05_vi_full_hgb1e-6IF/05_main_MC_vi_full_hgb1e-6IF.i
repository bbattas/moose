##############################################################################
# File: 05_main_MC_vi_full_hgb1e-6IF.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/02_buildup/05_vi_full_hgb1e-6IF
...
# -----
# Description:
#  Testing input 04 the if threshold on hgb for ci especially, but using a
#   lower limit of 1e-6 instead of the 1e-4 from 04
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 05_sub_NMC_vi_full_hgb1e-6IF_1step.i
  []
[]

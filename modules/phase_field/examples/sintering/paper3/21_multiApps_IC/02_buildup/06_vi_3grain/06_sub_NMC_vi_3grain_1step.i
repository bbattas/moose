##############################################################################
# File: 06_sub_NMC_vi_3grain_1step.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/02_buildup/06_vi_3grain
# Created Date: Tuesday August 6th 2024
# Author: Battas,Brandon Scott (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday August 7th 2024
# Modified By: Battas,Brandon Scott
# -----
# Description:
#  Using a different grain structure with a horizontal GB on the right so that
#   i can see some gb accelerated sintering/densification/pore shrinkage
#  IC function based on GPMultiphase Test input multiplying two parts to combine
#
##############################################################################

##############################################################################
# File: 08_main_MC_vi_3grain_coarse_BCspecified.i
...
# -----
# Description:
#  same as 07 but specifying a neumann bc = 0 for all variables
#
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 08_sub_NMC_vi_3grain_coarse_BCspecified_1step.i
  []
[]

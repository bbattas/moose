##############################################################################
# File: 09_main_MC_vi_3grain_externalPore.i
...
# -----
# Description:
#  Added an external pore region to the problem on the right hand side!
#
#  It was just all GG basically?!?
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 09_sub_NMC_vi_3grain_externalPore_1step.i
  []
[]

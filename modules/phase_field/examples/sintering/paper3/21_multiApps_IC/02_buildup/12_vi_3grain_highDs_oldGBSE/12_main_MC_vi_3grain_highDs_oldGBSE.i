##############################################################################
# File: 12_main_MC_vi_3grain_highDs_oldGBSE.i
...
# -----
# Description:
#  Trying using a slightly smaller pore and the old gb and surface energy values
#
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = 12_sub_NMC_vi_3grain_highDs_oldGBSE_1step.i
  []
[]

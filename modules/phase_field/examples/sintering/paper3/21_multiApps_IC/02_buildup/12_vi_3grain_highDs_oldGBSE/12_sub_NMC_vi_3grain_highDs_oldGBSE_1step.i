##############################################################################
# File: 12_sub_NMC_vi_3grain_highDs_oldGBSE_1step.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/02_buildup/12_vi_3grain_highDs_oldGBSE
...
# -----
# Description:
#  slightly smaller pore (4500 r instead of 5000), for a test using the old
#  GB and surf energy values to see if those (with the high Ds) are enough to
#  make the pore shrink at all
#
##############################################################################
...
[Functions]
  ...
  [ic_func_pore] # Right side pore
    type = ParsedFunction
    symbol_names = 'iw x0 y0 r'
    symbol_values = '1000 30000 7500 4500'

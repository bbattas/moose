##############################################################################
# File: 02_v_allScaledDgb.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/03_noGB_ripening/02_v_allScaledDgb
...
# -----
# Description:
#  Using the scaled Dgb value everywhere
#  (bulk vapor gb surface)
#  Setting D0 = scaling factor * D0_GB so all are scaled (1.5*GBw/IW)
#  hgb = 0 so all C values are bulk
#
##############################################################################

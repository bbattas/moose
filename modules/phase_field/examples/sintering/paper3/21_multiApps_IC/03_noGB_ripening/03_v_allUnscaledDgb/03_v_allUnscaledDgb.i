##############################################################################
# File: 03_v_allUnscaledDgb.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/03_noGB_ripening/03_v_allUnscaledDgb
...
# -----
# Description:
#  Using the UNscaled Dgb value everywhere
#  (bulk vapor gb surface)
#  Setting D0 = D0_GB so all are unscaled

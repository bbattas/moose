##############################################################################
# File: 09_vi_scaledDgb_highDs.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/03_noGB_ripening/09_vi_scaledDgb_highDs
...
# -----
# Description:
#  Vac and int using the respective gb D value for all D components (scaled DGB)
#   EXCEPT Ds = 100x that
#
#
##############################################################################

##############################################################################
# File: 13_v_allScaledDgb_long.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/03_noGB_ripening/13_v_allScaledDgb_long
# Created Date: Thursday August 15th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Thursday August 15th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  running this thing WAY longer to see that it actually does shrink eventually
#  Since unscaled completed but these barely changed at all
#
#
##############################################################################
...
[Transfers]
  [from_NMC]
    ...
    source_variable = 'gr0 phi cvac_aux'
    variable = 'gr0 phi cvac_var'
  []
[]
...
[Materials]
  ...
  [chiu]
    ...
    property_name = chiu
    # derivative_order = 2
    material_property_names = 'chi(wvac,phi,gr0) Va'
    expression = 'Va * chi'
  []
  [chiuD]

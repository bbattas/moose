##############################################################################
# File: 04_sub_betterSize_NMC_1step.i
...
# -----
# Description:
#  Including exterior region, looking at something where the grains are kinda
#   sized more reasonably?
#  Assuming 8um Diameter grains, r=4 Area=~50 um2, fo for a rectangle that would
#   be 5x10um, but if we assume only half in the domain here then 5x5 works each
##############################################################################

##############################################################################
# File: 05_sub_smallPore_NMC_1step.i
...
# -----
# Description:
#  small pore (r=2000=iw) with the external region (the larger one the gb btw pore
#   and surface was too short once it went lenticular i think?
#
#
##############################################################################
...
[Functions]
  [ic_func_pore] # Pore and exterior right
    ...
    symbol_values = '1000 10000 10000 2000 20000'

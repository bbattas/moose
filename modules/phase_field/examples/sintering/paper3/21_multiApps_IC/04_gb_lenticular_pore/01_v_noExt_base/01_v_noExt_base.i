##############################################################################
# File: 01_v_noExt_base.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/04_gb_lenticular_pore/01_v_noExt_base
...
# -----
# Description:
#  vacancy only sintering test looking at the lenticular pore WITHOUT any external
#   void region
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../00_sub/01_sub_noExternal_NMC_1step.i
  []
[]

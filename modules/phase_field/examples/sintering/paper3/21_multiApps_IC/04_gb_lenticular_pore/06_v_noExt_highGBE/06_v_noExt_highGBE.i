##############################################################################
# File: 06_v_noExt_highGBE.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/04_gb_lenticular_pore/06_v_noExt_highGBE
...
# -----
# Description:
#  using the old larger value for GB Energy (9.87ish) to see how that accelerates
#   the whole thing
#
#
##############################################################################

##############################################################################
# File: 07_v_smallPore_base.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/04_gb_lenticular_pore/07_v_smallPore_base
...
# -----
# Description:
#  Using a smaller pore with no external region to see how that compares?
#
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../00_sub/02_sub_noExternal_smallPore_NMC_1step.i
  []
[]

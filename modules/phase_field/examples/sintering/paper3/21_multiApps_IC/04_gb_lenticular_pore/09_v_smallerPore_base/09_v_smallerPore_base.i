##############################################################################
# File: 09_v_smallerPore_base.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/04_gb_lenticular_pore/09_v_smallerPore_base
...
# -----
# Description:
#  Pore size down 1 OOM and whole problem doing the same, but with the mesh and
#   pore still centered in the same place
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../00_sub/03_sub_noExternal_smallerPore_NMC_1step.i
  []
[]

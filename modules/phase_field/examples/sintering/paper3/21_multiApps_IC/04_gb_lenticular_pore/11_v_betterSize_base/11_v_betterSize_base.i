##############################################################################
# File: 11_v_betterSize_base.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/04_gb_lenticular_pore/11_v_betterSize_base
...
# -----
# Description:
#  Testing with the mathed out 8um ESD equivalent grains with half each grain in
#   the domain with a smaller pore between them, but iw is now 400nm so mesh elements
#   are like 100nm each, so just one grain has like 80 across it in one way
#
##############################################################################

##############################################################################
# File: 12_v_freeEnergyOutputs.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/04_gb_lenticular_pore/12_v_freeEnergyOutputs
...
# -----
# Description:
#  Vacancy only outputting various parts and components of the free energy
#
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../00_sub/00_sub_NMC_1step.i
  []
[]

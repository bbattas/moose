##############################################################################
# File: 13_v_freeEnergy_smallPore.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/04_gb_lenticular_pore/13_v_freeEnergy_smallPore
...
# -----
# Description:
#  using the small pore (2000=r=iw) so that the gb btw surface and pore is
#   longer and wont just dissapear like 12
#
#
##############################################################################

##############################################################################
# File: 14_v_FE_small_highKVoid.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/04_gb_lenticular_pore/14_v_FE_small_highKVoid
# Created Date: Saturday August 17th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Saturday August 17th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Same as input 13 but with the void phase k increased 1 OoM to see what it
#  does to free energy and grand potential?
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../00_sub/05_sub_smallPore_NMC_1step.i
  []
[]
...
[Materials]
  ...
  [k_constants]
    ...
    prop_values = '6.569e2 6.569e3 6.569e2 6.569e3' # 5.461e7 5.461e7' # No Irradiation
  []
  [gb_e_mat] # eV/nm^2
    type = ParsedMaterial

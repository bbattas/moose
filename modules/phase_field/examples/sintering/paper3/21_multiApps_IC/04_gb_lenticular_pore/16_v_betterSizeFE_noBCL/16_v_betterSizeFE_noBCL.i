##############################################################################
# File: 16_v_betterSizeFE_noBCL.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/04_gb_lenticular_pore/16_v_betterSizeFE_noBCL
...
# -----
# Description:
#  refined input with better pore size, but using no zero flux on the left boundary
#   so that maybe the pore wont shrink there?
#
#
##############################################################################

...
# -----
# Description:
#  sub input for 1e-8 FR irradiation c using the finer mesh (8 across the interface)
#  Running to 10k seconds to let it relax the EBSD interfaces
#  Same as no Irr just using ceq and ks of the irradiation value
#
##############################################################################

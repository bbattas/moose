##############################################################################
# File: 01_noIrr_icFine.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/01_noIrr_icFine
...
# -----
# Description:
#  9 grain fine mesh (250nm elements 8 across iw) with 8 pores for NO irradiation
#
#
#
##############################################################################
...
[Transfers]
  [from_NMC]
    ...
    source_variable = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 phi cvac_aux cint_aux'
...
[Materials]
  ...
  [csueq_mask]
    ...
    coupled_variables = 'phi gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7' # gr1 gr2'
    derivative_order = 2

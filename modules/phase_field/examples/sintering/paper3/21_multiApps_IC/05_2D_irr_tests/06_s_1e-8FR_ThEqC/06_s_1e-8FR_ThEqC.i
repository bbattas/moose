##############################################################################
# File: 06_s_1e-8FR_ThEqC.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/06_s_1e-8FR_ThEqC
...
# -----
# Description:
#  Using a fission rate of 1e-8 with the irradiation enabled but still keeping
#   all the theq values for c and k
#  NOTE: the recombination/generation is still iffy here (caused issues in the
#   bigger test- recombined the pores away completely)
##############################################################################

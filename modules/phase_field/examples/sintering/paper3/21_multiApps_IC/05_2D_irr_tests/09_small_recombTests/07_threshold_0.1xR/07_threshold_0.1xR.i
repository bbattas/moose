##############################################################################
# File: 07_threshold_0.1xR.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/09_small_recombTests/07_threshold_0.1xR
# Created Date: Thursday August 29th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Thursday August 29th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  using input 01 but usign 0.1x the Recombination rate
#
#
#
##############################################################################
...
[Materials]
  ...
  [rho_recomb] #This one is off on GB?
    ...
    expression = 'out:=a_r * combined_rho_vac * combined_rho_int * Va;
                  if((out>0.0 & combined_rho_int>=0.0 & combined_rho_vac>=0.0 & hv<=1e-4),0.0-0.1*out,0.0)'
    outputs = nemesis #'nemesis'
  []
  [rho_mixing_vac]
    type = DerivativeParsedMaterial

##############################################################################
# File: 09_noTJ_gen.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/09_small_recombTests/09_noTJ_gen
...
# -----
# Description:
#  Trying reducing generation (on TJ) to see if that helps
#
#
#
##############################################################################
...
[Materials]
  ...
  [rho_gen]
    ...
    expression = 'rg:=f_dot * noise * Nc * Nd * hs * Va * (1 - htj);
                  if(hv<=1e-6,rg,0)'

##############################################################################
# File: 01_2D_scaled_10xGB.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/10_Ds_testing/01_2D_1pore_irrEq/01_2D_scaled_10xGB
...
# -----
# Description:
#  Starting point/reference for Ds, using the 1e-6 hv threshold on gen and recomb
#  Using the hard coded value thats 10x Dgb for vac and int, with iw scaling
#   AFTER the 10x, so its really 10x the iw scaled Dgb
#  68k DoF so 6 cpus is good
##############################################################################

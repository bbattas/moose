##############################################################################
# File: 08_2D_scaled_10000xGB.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/10_Ds_testing/01_2D_1pore_irrEq/08_2D_scaled_10000xGB
# Created Date: Wednesday September 11th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday September 11th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Test of 10000x gb to see if it starts speeding up the densificaiton FFC now that
#  the shape is about right at 1000x
#
#
##############################################################################
...
[Materials]
  ...
  [chiiD]
    ...
    surfindex = 1.3989e12 #-1 #100 #1e11
    GBwidth = 3.5 # based on avg of two lanl values
    surf_thickness = 3.5 # keeping equal to gb for simplicity
    iw_scaling = true

...
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/10_Ds_testing/03_2D_1pore_thEq/03_2D_scaled_1000xGB
...
# -----
# Description:
#  Ds = 1000x Dgb, then with iw scaling
#  Using thermal eq c and k
#
#
##############################################################################

...
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/10_Ds_testing/03_2D_1pore_thEq/07_2D_scaled_10xGB_0FR
...
# -----
# Description:
#  Base Ds = 10xDgb, with iw scaling.  Using Thermal Eq values for c and k though!
#  ALSO setting fission rate to 0 so its recombination only no irradiaiton basically
#
#
##############################################################################

...
# -----
# Description:
#  no irr case to match the extreme test of 10,000xGB where i was checking that
#   pore area ffc in irradiation starts accelerating with increasing ds past 1000x
#
#
##############################################################################

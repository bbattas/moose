##############################################################################
# File: 04_3D_scaled_10xGB_0FR.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/10_Ds_testing/04_3D_1pore_thEq/04_3D_scaled_10xGB_0FR
...
# -----
# Description:
#  Base 3D input, using Ds = 10xDgb for v and i, then iw scaling applied to that
#  Using fission rate of 0 so its recomb only no irradiation basically
#  THERMAL EQ c and k

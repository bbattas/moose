##############################################################################
# File: 06_3D_scaled_1000xGB_0FR.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/05_2D_irr_tests/10_Ds_testing/04_3D_1pore_thEq/06_3D_scaled_1000xGB_0F
...
# -----
# Description:
#  Testing the other Ds values for theq 0FR/no irr
#  Ds = 1000xDGB
#  For vac thats an index of 5.8422e+10 while int is 1.3989e+11
#  Thermal c and k values
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../../00_sub/04_sub_3D_noIrr.i
  []
[]

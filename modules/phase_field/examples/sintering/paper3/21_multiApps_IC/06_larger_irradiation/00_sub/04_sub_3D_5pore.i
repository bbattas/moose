...
# -----
# Description:
#  subfile for the 3D 12x12x12um 5 pore (5% vol) input
#   still have pore(s) really close to the surface but thats the best i could do
#   with 1.2xradii for the separation
# 1.3m dofs so like 4 or 5 nodes is fine
# Some overlap in pores? two of them seem to be overlapping a bit so not ideal
#  but itll work for an early 3D test with a small number of DoFs like this
##############################################################################

[Mesh]
  [ebsd_mesh]
    type = EBSDMeshGenerator
    filename = 3D_12x12x12um_8umavg_5pore.txt
  []
  [subdomain_external]
    type = ParsedSubdomainMeshGenerator
    input = ebsd_mesh
    combinatorial_geometry = 'x > 10500'
    block_id = 1
  []
...
[ICs]
  ...
  [voidIC2] #Internal
    ...
    invalue = 1
    outvalue = 0 #0.01
    radii = '1609.22 1551.23 1482.79 1818.2  1511.86'
    x_positions = '4464.03 8414.3  4296.37 8255.32 3484.5 '
    y_positions = '7429.78 8054.35 3703.45 3741.66 6540.98'
    z_positions = '5155.16 8404.9  8557.26 4019.04 5747.25'
    block = 0
  []
[]

...
# -----
# Description:
#  New 3 pore subfile, 13um cube with 10 grains, 3 pores 2% solid volume, 3 um extra pore
#  2m DoFs in this NMC Subfile
#
#
##############################################################################
...
[Mesh]
  [ebsd_mesh]
    ...
    filename = 3D_13x13x13um_8umavg_3pore.txt
  []
  [subdomain_external]
    type = ParsedSubdomainMeshGenerator
    input = ebsd_mesh
    combinatorial_geometry = 'x > 11500'
    block_id = 1
  []
...
[ICs]
  ...
  [voidIC2] #Internal
    ...
    invalue = 1
    outvalue = 0 #0.01
    radii = '1598.2  1477.63 1470.76'
    x_positions = '7929.94 5018.42 4603.22'
    y_positions = '4617.59 8291.05 8579.56'
    z_positions = '4341.68 8728.85 6725.54'
    block = 0
  []
[]

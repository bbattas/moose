...
# -----
# Description:
#  Subfile for the 16(+3)x16x16 um cube with 3 pores (3% vol and 1.5xR sep)
#  Should need about 2x the CPUs of the 13 um cube so like 15/16 nodes on HPG?
#
#
##############################################################################
...
[Mesh]
  [ebsd_mesh]
    ...
    filename = 3D_16x16x16um_8umavg_3pore.txt
  []
  [subdomain_external]
    type = ParsedSubdomainMeshGenerator
    input = ebsd_mesh
    combinatorial_geometry = 'x > 14500'
    block_id = 1
  []
...
[ICs]
  ...
  [voidIC2] #Internal
    ...
    invalue = 1
    outvalue = 0 #0.01
    radii = '2090.61 2091.29 2227.48'
    x_positions = ' 7472.77 10136.67  8306.06'
    y_positions = ' 5569.59 10667.36  6691.86'
    z_positions = '10289.47  5560.04  7680.09'
    block = 0
  []
[]

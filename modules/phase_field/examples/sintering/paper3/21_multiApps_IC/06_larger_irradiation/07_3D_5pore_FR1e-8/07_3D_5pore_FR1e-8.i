##############################################################################
# File: 07_3D_5pore_FR1e-8.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/06_larger_irradiation/07_3D_5pore_FR1e-8
...
# -----
# Description:
#  first attempt at 3d test, using 5pore 5% volume small domain 3d which has like
#   13m dofs so 4-5 nodes works.  though the pores 2 of them are overlapping a
#   little bit but itll work for this first test
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../00_sub/04_sub_3D_5pore.i
  []
[]

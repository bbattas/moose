##############################################################################
# File: 12_3D_3pore_FR1e-8.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/06_larger_irradiation/12_3D_3pore_FR1e-8
# Created Date: Wednesday September 25th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday September 25th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  new 13um cube with 3um extra pore and 3 pores totalling 2% volume
#  Subfile had 2m DoFs, this has about 2.4m, so only like 5 INL nodes
#   on HPG well use 8 nodes of 30 is fine
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../00_sub/05_sub_3D_3pore.i
  []
[]
...
[Transfers]
  [from_NMC]
    ...
    source_variable = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 phi cvac_aux_ir cint_aux_ir'
    variable = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 phi cvac_var cint_var'
  []
[]

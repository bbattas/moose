##############################################################################
# File: 01_2D_100um_IC1_FR1e-8_irrC.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/07_2D_large/01_2D_100um_IC1_FR1e-8_irrC
...
# -----
# Description:
#  Irradiation c and k using IC 1 of the 100x100um 2D 25 pore case with fission
#
#
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../00_sub/01_sub_2D_IC1.i
  []
[]

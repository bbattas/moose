##############################################################################
# File: 03_8optIts.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/08_timestepping/03_8optIts
...
# -----
# Description:
#  8 opt its instead of 6 (with the high LpNL 1e5 so adapting is NL only)
#  Input 2 with 8 instead of 6 opt its basically
#
#
##############################################################################

##############################################################################
# File: 05_shortSwitch0.3_noNegIf.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/08_timestepping/05_shortSwitch0.3_noNegIf
# Created Date: Wednesday October 30th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Wednesday October 30th 2024
# Modified By: Brandon Battas
# -----
# Description:
#  High LpNL (02) with:
#  Using the new recombmat option to use the 0-0.3 interface for hs while still
#   having the if cutoff for negative recombination
#
##############################################################################

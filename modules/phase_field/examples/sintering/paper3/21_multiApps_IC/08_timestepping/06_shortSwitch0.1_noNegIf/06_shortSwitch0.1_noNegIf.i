##############################################################################
# File: 06_shortSwitch0.1_noNegIf.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/08_timestepping/06_shortSwitch0.1_noNegIf
# Created Date: Wednesday October 30th 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Thursday October 31st 2024
# Modified By: Brandon Battas
# -----
# Description:
#  same thing as 05 but with the threshold on the narrow switching function at
#   0.1 instead of 0.3, so no negative if on recomb but hs is just the 1-0.9
#   width interface before its 0
#
##############################################################################

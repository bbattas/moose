##############################################################################
# File: 07_shortSwitch0.3.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/08_timestepping/07_shortSwitch0.3
...
# Description:
#  High LpNL (02) with:
#  Using the new recombmat option to use the 0-0.3 interface for hs while also
#   REMOVING the if cutoff for negative recombination
#
##############################################################################

##############################################################################
# File: 13_long_doubleifR.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/08_timestepping/13_long_doubleifR
...
# -----
# Description:
#  Input 02 but with a much longer end time to see how the changed recombination
#   is working between this way and the other two short interface hs options
#
#
##############################################################################

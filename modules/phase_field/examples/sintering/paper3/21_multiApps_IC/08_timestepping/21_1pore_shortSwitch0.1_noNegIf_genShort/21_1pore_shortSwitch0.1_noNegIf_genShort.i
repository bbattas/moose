##############################################################################
# File: 21_1pore_shortSwitch0.1_noNegIf_genShort.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/08_timestepping/21_1pore_shortSwitch0.1_noNegIf_genShort
...
# -----
# Description:
#  1 pore version of the short hs with if for negative recombination
#  AND with gen on the short hs instead of threshold
#
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../00_sub/01_sub_2D_1pore.i
  []
[]
...
[Transfers]
  [from_NMC]
    ...
    source_variable = 'gr0 gr1 phi cvac_aux_ir cint_aux_ir'

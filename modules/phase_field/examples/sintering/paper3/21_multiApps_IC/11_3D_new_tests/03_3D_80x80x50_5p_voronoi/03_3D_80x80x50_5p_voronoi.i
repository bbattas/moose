##############################################################################
# File: 03_3D_80x80x50_5p_voronoi.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/11_3D_new_tests/03_3D_80x80x50_5p_voronoi
...
# -----
# Description:
#  Voronoi with specified centers
#
#
#
##############################################################################
...
[UserObjects]
  ...
  [voronoi]
    ...
    grain_num = 1499
    file_name = '3D_80x80x50_ctrs.txt'
    coloring_algorithm = bt
  []
  [grain_tracker]
    type = GrainTracker

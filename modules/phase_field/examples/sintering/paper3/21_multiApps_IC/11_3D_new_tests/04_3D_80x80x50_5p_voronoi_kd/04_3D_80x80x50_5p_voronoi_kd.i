##############################################################################
# File: 04_3D_80x80x50_5p_voronoi_kd.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/11_3D_new_tests/04_3D_80x80x50_5p_voronoi_kd
# Created Date: Tuesday July 7th 2026
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday July 7th 2026
# Modified By: Brandon Battas
# -----
# Description:
#  Voronoi specified centers with pgraph and with kdtree in voronoi UO
#
#
#
##############################################################################
...
[Mesh]
  ...
  [subdomain_external]
    ...
    input = gmg
    combinatorial_geometry = 'x > 80000'
    block_id = 1
  []
...
[UserObjects]
  ...
  [voronoi]
    ...
    # grain_num = 1499
    file_name = '../03_3D_80x80x50_5p_voronoi/3D_80x80x50_ctrs.txt'
    coloring_algorithm = bt
    use_kdtree = true
  []
  [grain_tracker]

##############################################################################
# File: 05_3D_50x50x25_voronoi_kd.i
# File Location: /examples/sintering/paper3/21_multiApps_IC/11_3D_new_tests/05_3D_50x50x25_voronoi_kd
# Created Date: Monday July 13th 2026
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Monday July 13th 2026
# Modified By: Brandon Battas
# -----
# Description:
#  3D 50x50x25 domain to cut way down on the domain to just find somthing that works
#  ALSO not using voronoi void, just the grains and the external region
#
#
##############################################################################
...
[Mesh]
  ...
  [subdomain_external]
    ...
    input = gmg
    combinatorial_geometry = 'x > 50000'
    block_id = 1
  []

...
# File Location: /examples/sintering/test_inputs/02_mac_newForkTest/2D_IWScalingTest_20iw.i
...
[Materials]
  ...
  [cv_eq]
    ...
    c = phi
    OU = OU
    gb_se_csv = '/Users/bbattas/projects/moose/modules/phase_field/examples/sintering/gb_segregation_csv/sigma9_se.csv
                 /Users/bbattas/projects/moose/modules/phase_field/examples/sintering/gb_segregation_csv/sigma11_se.csv'
    outputs = 'none'
  []
  [sintering]

##############################################################################
# File: 04_hpg_badNodeTest.i
# File Location: /examples/sintering/test_inputs/04_hpg_badNodeTest
...
# -----
# Description:
#  Simple input used to launch this same simulation with no outputs
#  several times to locate bad nodes in HPG
#  74k DoFs so can run on 4 cpus for 18k per cpu
#
##############################################################################

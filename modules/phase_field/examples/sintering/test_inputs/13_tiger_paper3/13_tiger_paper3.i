##############################################################################
# File: 13_tiger_paper3.i
# File Location: /examples/sintering/test_inputs/13_tiger_paper3
# Created Date: Tuesday October 1st 2024
# Author: Brandon Battas (bbattas@ufl.edu)
# -----
# Last Modified: Tuesday October 1st 2024
# Modified By: Brandon Battas
# -----
# Description:
#  Copy of a multiapps multigrain multipore input that ill run a couple steps
#   to use to debug why my tiger script for this paper3 type structure stopped
#   working the way it should/at all?
#
##############################################################################
...
[MultiApps]
  [full_NMC]
    ...
    execute_on = initial
    positions = '0 0 0'
    input_files = ../../paper3/21_multiApps_IC/06_larger_irradiation/00_sub/01_sub_2D_9grain.i
  []
[]
